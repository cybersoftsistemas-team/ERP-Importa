object Cadastro_PCTerceirosClientes: TCadastro_PCTerceirosClientes
  Left = 377
  Top = 181
  BorderStyle = bsDialog
  Caption = 'Cadastro_PCTerceirosClientes'
  ClientHeight = 562
  ClientWidth = 1101
  Color = clBtnFace
  ...
  object tClientes: TMSQuery
    ...
    SQL.Strings = (
      'SELECT Codigo'
      '      ,Nome'
      '      ,CNPJ = CASE WHEN CNPJ <> '#39#39' THEN CNPJ ELSE CPF END'
      '      ,Pessoa = CASE WHEN CNPJ <> '#39#39' THEN '#39'JUR'#39' ELSE '#39'FIS'#39' END'
      'FROM  Cybersoft_Ali_Matriz.dbo.Clientes'
      'WHERE  Pais = 1058'
      'AND ISNULL(Ativo, 0) = 1'
      'AND ISNULL(Conta_Ativo, '#39#39') = '#39#39
      'ORDER  BY Nome')
    FetchRows = 1
    Left = 254
    Top = 319
    object tClientesCodigo: TIntegerField
      FieldName = 'Codigo'
      Origin = 'Cybersoft_Ali_Matriz.dbo.Clientes.Codigo'
    end
    ...
    object tClientesNome: TStringField
      FieldName = 'Nome'
      Origin = 'Cybersoft_Ali_Matriz.dbo.Clientes.Nome'
      Size = 50
    end
    object tClientesPessoa: TStringField
      FieldName = 'Pessoa'
      ReadOnly = True
      Size = 3
    end
