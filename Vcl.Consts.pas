...
resourcestring
  SSelectADate = 'Selecione a data';
  SOpenFileTitle = 'Abrir';
  SCantWriteResourceStreamError = 'Não é possível gravar em um fluxo de recursos somente leitura';
  SDuplicateReference = 'WriteObject chamado duas vezes para a mesma instância';
  SClassMismatch = 'O recurso %s é de classe incorreta';
  SInvalidTabIndex = 'Índice de tabulação fora dos limites';
  SInvalidTabPosition = 'Posição da guia incompatível com o estilo da guia atual';
  SInvalidTabStyle = 'Estilo da guia incompatível com a posição da guia atual';
  SInvalidBitmap = 'A imagem bitmap não é válida';
  SInvalidIcon = 'A imagem do ícone não é válida';
  SInvalidMetafile = 'O metarquivo não é válido';
  SInvalidPixelFormat = 'Invalid pixel format';
  SInvalidImage = 'Imagem Invalida';
...
{$ENDIF}
  ...
  STooManyDeleted = 'Muitas linhas ou colunas excluídas';
  SIndexOutOfRange = 'Índice de grade fora do intervalo';
  ...
  srUnknown = '(Unknown)';
  srNone = '(None)';
  SOutOfRange = 'Valor deve estar entre %d and %d';

  SDateEncodeError = 'Argumento inválido para codificar a data';
  SDefaultFilter = 'All files (*.*)|*.*';
  sAllFilter = 'All';
  SNoVolumeLabel = ': [ - no volume label - ]';
  SInsertLineError = 'Unable to insert a line';

  SConfirmCreateDir = 'O diretório especificado não existe. Criar?';
  SSelectDirCap = 'Selecione o diretório';
  SDirNameCap = 'Directorio &Nome:';
  SDrivesCap = 'D&rives:';
  ...
  SInvalidMemoSize = 'O texto excede a capacidade do memo';
