object Utilitarios_ExportaADECOFIS: TUtilitarios_ExportaADECOFIS
  Left = 416
  Top = 298
  BorderStyle = bsDialog
  Caption = 'Utilitarios_ExportaADECOFIS'
  ClientHeight = 180
  ClientWidth = 431
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 304
    Height = 18
    Caption = 'Gera'#231#227'o de Arquivos magn'#233'ticos para ADE COFIS'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object tParticipantes: TMSQuery
    SQLInsert.Strings = (
      'INSERT INTO LayoutExportacao'
      '  (Layout, Nome, [Descri'#231#227'o], Nome_Arquivo)'
      'VALUES'
