...
uses
  SysUtils, Classes, StrUtils, variants, dialogs,
...
begin
  AXML := FXMLAssinado;
  Evento := SchemaReinfToStr(Schema) + PrefixVersao + VersaoReinfToStrHibrido(TACBrReinf(FACBrReinf).Configuracoes.Geral.VersaoDF);
  if EstaVazio(AXML) then begin
     Assinar(AXML, Evento);
     AXML := FXMLAssinado;
  end;
