object Impressao_FiscaisOP_DIFAL: TImpressao_FiscaisOP_DIFAL
  Left = 579
  Top = 350
  BorderStyle = bsDialog
  Caption = 'Impressao_FiscaisOP_DIFAL'
  ClientHeight = 181
  ClientWidth = 315
  Color = clBtnFace
  ...
  object tDIFAL: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,DIFAL_AliqInterna'
      '      ,Valor_ICMSDest'
      '      ,DIFAL = (DIFAL_AliqInterna - Aliquota_ICMSOper)'
      '      ,DIFAL_ValorOrig'
      '      ,DIFAL_ValorDest'
      
        '      ,FCP_Aliquota = ISNULL((SELECT FCP FROM ICMS WHERE UF = De' +
        'stinatario_Estado), 0)'
      '      ,FCP_ValorDest'
      'FROM NotasFiscais '
      'WHERE DIFAL_Valor > 0'
      'ORDER BY Destinatario_Estado, Data_Emissao, Nota'
      '')
    Active = True
    Left = 195
    Top = 43
  end
  object rDIFAL: TppReport
    AutoStop = False
    DataPipeline = pDIFAL
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Controle de DIFAL'
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo_Fonte\Relatorios\Controle_DIFAL.r' +
      'tm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lPeriodo: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = 'Per'#237'odo 01/01/2016 a 31/01/2016'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
  ...
  object pDIFAL: TppDBPipeline
    DataSource = dsTDIFAL
    UserName = 'pDIFAL'
    Left = 259
    Top = 51
    object pDIFALppField1: TppField
    ...
    object pDIFALppField2: TppField
    ...
    object pDIFALppField3: TppField
    ...
    object pDIFALppField4: TppField
    ...
    object pDIFALppField5: TppField
    ...
    object pDIFALppField6: TppField
      Alignment = taRightJustify
    ...
    object pDIFALppField7: TppField
    ...
    object pDIFALppField8: TppField
      Alignment = taRightJustify
    ...
    object pDIFALppField9: TppField
    ...
    object pDIFALppField10: TppField
      Alignment = taRightJustify
      FieldAlias = 'DIFAL'
      FieldName = 'DIFAL'
      FieldLength = 0
    ...
    object pDIFALppField11: TppField
    ...
    object pDIFALppField12: TppField
    ...
    object pDIFALppField13: TppField
      Alignment = taRightJustify
    ...
    object pDIFALppField14: TppField
