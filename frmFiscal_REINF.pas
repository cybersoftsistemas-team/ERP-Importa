unit frmFiscal_REINF;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.ExtCtrls, ReinfClientX_TLB, Vcl.ComCtrls,
  ACBrBase, ACBrDFe, ACBrReinf, DB, ShellApi;

type
  TFiscal_REINF = class(TForm)
    Ambiente: TLabel;
    lbl1: TLabel;
    lbl2: TLabel;
...
procedure TFiscal_REINF.btnConfigurarClick(Sender: TObject);
begin
      mmoXml.Clear;
...
procedure TFiscal_REINF.btnTx2Click(Sender: TObject);
begin
      mmoXML.Clear;
...
procedure TFiscal_REINF.btnXmlClick(Sender: TObject);
begin
     //Reinf.CriarEventoReinf("C:\ACBrMonitorPlus\Reinf\Eventos\R1000.ini")
     {
     mmoXml.Text := Reinf.GerarXMLporTx2(mmoXml.Text);
     //mmoXmlEnvio.Lines.Add(mmoXML.Text);
     mmoXML.Lines.SaveToFile('c:\temp\REINF\REINF.xml');
     ShellExecute(Handle, 'Open', PChar('c:\temp\REINF\REINF.xml'), '', '', SW_ShowNormal);
     }
end;

procedure TFiscal_REINF.btnAssinarClick(Sender: TObject);
begin
     mmoXml.Text := Reinf.AssinarEvento(mmoXml.Text);
end;

procedure TFiscal_REINF.btnEnviarClick(Sender: TObject);
var
...
procedure TFiscal_REINF.btnConsultarClick(Sender: TObject);
var
...
begin
      ...
      for _i := 0 to _RetConsulta.Count - 1 do begin
          ...
          if not _RetConsultaItem.R5001.IsEmpty then begin
        ...
        //     mmoXML.Lines.Add('      TpInsc Estabelecimento: ' + _RetConsultaItem.R5001.IdeEstab.TpInsc);
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRTom - 1 do begin
                 ...
                 for _b := 0 to _RetItemRTomR5001.CountInfoCRTom - 1 do begin
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRComl - 1 do begin
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRCPRB - 1 do begin
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRPrest - 1 do begin
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRRecRepAD - 1 do begin
             ...
             for _j := 0 to _RetConsultaItem.R5001.CountRRecEspetDesp - 1 do begin
        ...
        if not _RetConsultaItem.R5011.IsEmpty then begin
           for _j := 0 to _RetConsultaItem.R5011.CountRTom - 1 do begin
               ...
               for _b := 0 to _RetItemRTomR5011.CountInfoCRTom - 1 do begin
           ...
           for _j := 0 to _RetConsultaItem.R5011.CountRComl - 1 do begin
           ...
           for _j := 0 to _RetConsultaItem.R5011.CountRCPRB - 1 do begin
           ...
           for _j := 0 to _RetConsultaItem.R5011.CountRPrest - 1 do begin
           ...
           for _j := 0 to _RetConsultaItem.R5011.CountRRecRepAD - 1 do begin
        ...
        for _j := 0 to _RetConsultaItem.Count - 1 do begin
      ...
      for _i := 0 to _RetConsulta.CountOcorrencias - 1 do begin
...
procedure TFiscal_REINF.bSairClick(Sender: TObject);
begin
     Close;
end;

procedure TFiscal_REINF.FormShow(Sender: TObject);
begin
      with Dados do begin
           Empresas.Open;
           ...
           Fiscal_Reinf.Caption     := 'Reinf - TecnoSpeed - OCX ' + Reinf.Versao + ' - TLB ' + ReinfVersaoTLB;
           //cbCertificado.Items.Text := Reinf.ListarCertificados(#13#10);
           //cbVersao.Items.Text      := Reinf.ListarVersaoManual(#13#10);
           cbCertificado.Items.Text := Empresas.FieldByName('Certificado_Digital').AsString;
           cbCertificado.ItemIndex  := 0;
           cbVersao.ItemIndex       := 0;
           rgTipoConsulta.ItemIndex := 0;
           edtCnpjSH.Text           := '11222897000114';
           edtEmpregador.Text       := Empresas.FieldByName('CNPJ').AsString;
           cbAmbiente.ItemIndex     := Empresas.FieldByName('Ambiente_REINF').AsInteger-1;
           cbVersao.Text            := Empresas.FieldByName('Versao_REINF').AsString;
           if Empresas.FieldByName('Ambiente_REINF').AsInteger = 1 then
