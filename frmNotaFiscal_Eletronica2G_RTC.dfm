object NotaFiscal_Eletronica2G_RTC: TNotaFiscal_Eletronica2G_RTC
  Left = 798
  Top = 287
  ActiveControl = cDataEmissao
  BorderStyle = bsDialog
  Caption = 'NotaFiscal_Eletronica2G_RTC'
  ClientHeight = 579
  ClientWidth = 874
  Color = clBtnFace
  ...
  object lDescricao: TRxLabel
    ...
    Width = 278
    Height = 18
    Caption = 'Gera'#231#227'o e Envio de Notas Fiscais eletr'#244'nicas.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
