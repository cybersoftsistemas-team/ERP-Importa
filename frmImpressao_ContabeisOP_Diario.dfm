object Impressao_ContabeisOP_Diario: TImpressao_ContabeisOP_Diario
  Left = 511
  Top = 240
  BorderStyle = bsDialog
  Caption = 'Impressao_ContabeisOP_Diario'
  ClientHeight = 305
  ClientWidth = 300
  Color = clBtnFace
  ...
  object rDiario: TppReport
    AutoStop = False
    DataPipeline = pLancamentos
    ...
    Template.FileName = 
      'C:\Sistemas_XE\Faturamento\Codigo_Fonte\Relatorios\LivroDiario.r' +
      'tm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppShape1: TppShape
        DesignLayer = ppDesignLayer1
        UserName = 'Shape1'
        Brush.Color = 15788771
        Gradient.EndColor = 14660723
        Gradient.StartColor = 16768667
  ...
  object ppHistoricos: TppDBPipeline
    ...
    Left = 201
    Top = 183
    object ppHistoricosppField1: TppField
    ...
    object ppHistoricosppField2: TppField
    ...
    object ppHistoricosppField3: TppField
    ...
    object ppHistoricosppField4: TppField
      FieldAlias = 'Macro'
      FieldName = 'Macro'
      FieldLength = 0
      DataType = dtMemo
  ...
  object tLancamentos: TMSQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Data, Numero, Conta_Debito, Conta_Credito, Historico_Codi' +
        'go, Valor,'
      
        '      (SELECT Descricao FROM PlanoContas WHERE(Codigo = Lancamen' +
        'tos.Conta_Debito))  AS Nome_ContaD,'
      
        '      (SELECT Descricao FROM PlanoContas WHERE(Codigo = Lancamen' +
        'tos.Conta_Credito)) AS Nome_ContaC,'
      '      CASE WHEN Historico_Codigo <> 0 THEN '
      
        '          (SELECT LTRIM(RTRIM(Descricao)) FROM Cybersoft_Contabi' +
        'lidade.dbo.HistoricoPadrao WHERE(Codigo = Lancamentos.Historico_' +
        'Codigo))+'#39' '#39'+CAST(Historico_Complemento AS Varchar(200)) '
      '      ELSE'
      
        '          LTRIM(RTRIM(CAST(Historico_Complemento AS Varchar(200)' +
        ')))'
      '      END AS Historico_Texto'
      'FROM Lancamentos'
      '')
    Active = True
    Left = 201
  ...
  object pLancamentos: TppDBPipeline
    DataSource = dstLancamentos
    CloseDataSource = True
    UserName = 'pLancamentos'
    Left = 201
    Top = 231
    object pLancamentosppField1: TppField
      FieldAlias = 'Data'
      FieldName = 'Data'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object pLancamentosppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'Numero'
      FieldName = 'Numero'
      FieldLength = 0
    ...
    object pLancamentosppField3: TppField
      FieldAlias = 'Conta_Debito'
      FieldName = 'Conta_Debito'
      FieldLength = 6
      DisplayWidth = 6
      Position = 2
    end
    object pLancamentosppField4: TppField
      FieldAlias = 'Conta_Credito'
      FieldName = 'Conta_Credito'
      FieldLength = 6
      DisplayWidth = 6
      Position = 3
    end
    object pLancamentosppField5: TppField
      Alignment = taRightJustify
      FieldAlias = 'Historico_Codigo'
    ...
    object pLancamentosppField6: TppField
      FieldAlias = 'Valor'
      FieldName = 'Valor'
      FieldLength = 0
      DataType = dtCurrency
    ...
    object pLancamentosppField7: TppField
      FieldAlias = 'Nome_ContaD'
      FieldName = 'Nome_ContaD'
      FieldLength = 50
      DisplayWidth = 50
      Position = 6
    end
    object pLancamentosppField8: TppField
      FieldAlias = 'Nome_ContaC'
      FieldName = 'Nome_ContaC'
      FieldLength = 50
      DisplayWidth = 50
      Position = 7
    end
    object pLancamentosppField9: TppField
      FieldAlias = 'Historico_Texto'
      FieldName = 'Historico_Texto'
      FieldLength = 261
      DisplayWidth = 261
      Position = 8
    end
