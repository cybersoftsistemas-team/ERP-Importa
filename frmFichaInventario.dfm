object FichaInventario: TFichaInventario
  Left = 574
  Top = 268
  BorderStyle = bsDialog
  Caption = 'FichaInventario'
  ClientHeight = 331
  ClientWidth = 482
  Color = clBtnFace
  ...
  object lTitulo: TRxLabel
    ...
    Width = 237
    Height = 18
    Caption = 'Processamento da ficha de Inventario.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object Panel3: TPanel
    ...
    object lMensagem: TLabel
      ...
      Width = 213
      Height = 13
      Caption = 'Processando a ficha de inventario...Aguarde.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
