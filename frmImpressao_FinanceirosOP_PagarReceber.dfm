object Impressao_FinanceirosOP_PagarReceber: TImpressao_FinanceirosOP_PagarReceber
  Left = 486
  Top = 189
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 247
    Height = 18
    Caption = 'Rela'#231#227'o de Pagamentos/Recebimentos.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cFixas: TRadioGroup
    ...
    Items.Strings = (
      'Despesas Fixas'
      'Despesas n'#227'o Fixas'
      'Todos')
    TabOrder = 3
    OnClick = cDespesasClick
  end
  object cTotalDiario: TCheckBox
    Left = 10
    Top = 433
    Width = 137
    Height = 17
    Caption = 'Mostrar os totais di'#225'rios.'
    TabOrder = 16
  end
  object cTotalMensal: TCheckBox
    Left = 10
    Top = 450
    Width = 146
    Height = 17
    Caption = 'Mostrar os totais mensais.'
    TabOrder = 17
  end
  ...
  object cConsolidar: TCheckBox
    ...
    Width = 194
    Height = 17
    Caption = 'Totaliza por empresa (Consolida'#231#227'o).'
    TabOrder = 19
  end
  object cQuebraMes: TCheckBox
    Left = 10
    Top = 467
    Width = 141
    Height = 17
    Caption = 'Quebrar Pagina por m'#234's'
    TabOrder = 18
  end
  object cDocumentos: TRadioGroup
    Left = 614
    Top = 52
    Width = 92
    Height = 79
  ...
  object cDiferenciado: TCheckBox
    Left = 242
    Top = 450
    Width = 167
    Height = 17
    Caption = 'Apenas Clientes Diferenciados'
    TabOrder = 36
  end
  ...
  object cDRE: TRxDBLookupCombo
    ...
    LookupDisplay = 'Codigo; Descricao'
    LookupDisplayIndex = 1
    LookupSource = Dados.dsDRE
    ParentFont = False
    TabOrder = 39
    OnKeyDown = cClassificacaoKeyDown
  end
  object cAgruparClass: TCheckBox
    Left = 450
    Top = 433
    Width = 143
    Height = 17
    Caption = 'Agrupar por Classifica'#231#227'o'
    TabOrder = 38
    OnClick = cAgruparClassClick
  end
  ...
  object cCondicao: TRxDBLookupCombo
    Left = 132
    Top = 343
    Width = 575
    Height = 21
  ...
  object cAgruparBenef: TCheckBox
    Left = 450
    Top = 450
    Width = 143
    Height = 17
    Caption = 'Agrupar por Benefici'#225'rio'
    TabOrder = 44
  ...
  object tBeneficiario: TMSQuery
    ...
    object tBeneficiarioCPF: TStringField
      FieldName = 'CPF'
      ReadOnly = True
      Size = 14
    end
  ...
  object tTitulos: TMSQuery
    ...
    SQL.Strings = (
      ...
      '       PRB.Data AS Data_Baixado,'
      '       PRB.Banco_Conta AS Conta_Banco,'
      '       PR.Numero_Documento,'
      '       PR.Processo,'
      ...
      '       PR.Multa,'
      '       PR.Tipo,'
      '       PRB.Valor AS Valor_Baixa,'
      '       CASE'
      
        '           WHEN Fornecedor <> 0  THEN (SELECT Nome FROM Forneced' +
        'ores AS FRN WHERE(PR.Fornecedor = FRN.Codigo))'
      
        '           WHEN Cliente    <> 0  THEN (SELECT Nome FROM Clientes' +
        '     AS CLI WHERE(PR.Cliente = CLI.Codigo))'
      
        '           WHEN Orgao      <> '#39#39' THEN (SELECT Nome FROM Cybersof' +
        't_Cadastros.dbo.OrgaosPublicos AS OP WHERE(PR.Orgao = OP.Codigo)' +
        ')'
      '       END AS Nome_Beneficiario,'
      '       CASE'
      
        '           WHEN Fornecedor <> 0  THEN (SELECT CNPJ FROM Forneced' +
        'ores AS FRN WHERE(PR.Fornecedor = FRN.Codigo))'
      
        '           WHEN Cliente    <> 0  THEN (SELECT CNPJ FROM Clientes' +
        '     AS CLI WHERE(PR.Cliente = CLI.Codigo))'
      
        '           WHEN Orgao      <> '#39#39' THEN (SELECT CNPJ FROM Cybersof' +
        't_Cadastros.dbo.OrgaosPublicos AS OP WHERE(PR.Orgao = OP.Codigo)' +
        ')'
      '       END AS CNPJ_Beneficiario,'
      
        '       (SELECT Descricao FROM CentroCusto AS CC WHERE(PR.Centro_' +
        'Custo = CC.Codigo)) AS CentroCusto_Nome,'
      '       Classificacao, '
        ...
        '       CAST(MONTH(Data_Vencimento) AS VARCHAR(2))+CAST(YEAR(Data' +
        '_Vencimento) AS VARCHAR(4)) AS MesAno,'
      '       143 AS Empresa,'
      
        '       (SELECT CNPJ FROM Cybersoft_Cadastros.dbo.Empresas WHERE(' +
        'Codigo = 143)) AS CNPJ'
      'INTO   #TEMP'
      'FROM   PagarReceber PR, PagarReceberBaixas PRB'
      'WHERE  PR.Numero = PRB.Numero'
      'AND (Nivel <= 10) '
      'AND (PRB.Data BETWEEN '#39'03/01/2024'#39' AND '#39'03/31/2024'#39')'
        ...
        '--AND Cliente IN((SELECT Codigo FROM Clientes WHERE CNPJ = '#39'2331' +
        '4594001000'#39'))'
      
        '--AND Cliente IN((SELECT Codigo FROM Clientes WHERE substring(CN' +
        'PJ, 1, 8) = '#39'23314594'#39'))'
      ''
      
        'UPDATE #TEMP SET Valor_Total = 0 WHERE(Registro <> (SELECT MIN(R' +
        'egistro) FROM #TEMP PRB WHERE(PRB.Numero = #Temp.Numero)))'
      'SELECT * FROM #TEMP'
  ...
  object rF01b: TppReport
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\FinanceirosPagar' +
      'Receber.rtm'
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = 'Rela'#231#227'o de contas pagas'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object cSaldoAnterior: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cSaldoAnterior'
        AutoSize = False
        Border.mmPadding = 0
        BlankWhenZero = False
        CalcOrder = 0
    ...
    object ppSummaryBand2: TppSummaryBand
      ...
      object cTotalRecebido: TppVariable
        DesignLayer = ppDesignLayer1
      ...
      object cPagamentosBaixados: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cPago1'
        AutoSize = False
        Border.Weight = 1.000000000000000000
      ...
      object cRecebimentosBaixados: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cRecebimentosBaixados'
        AutoSize = False
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        BlankWhenZero = False
      ...
      object tSaldoRecebimentos: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'tSaldoRecebimentos'
        AutoSize = False
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        BlankWhenZero = False
      ...
      object ppLabel9: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = '(RECEBIMENTOS - PAGAMENTOS)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        Font.Size = 6
      ...
      object cTotalDiferenca: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cTotalDiferenca'
        AutoSize = False
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        BlankWhenZero = False
      ...
      object tSaldoPagamentos: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'tSaldoPagamentos'
        AutoSize = False
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        BlankWhenZero = False
      ...
      object ppLabel15: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = '(ANTERIOR + RECEBIMENTOS - PAGAMENTOS)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        Font.Size = 6
      ...
      object cTotalGeral: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cTotalGeral'
        AutoSize = False
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        BlankWhenZero = False
    ...
    object ppGroup6: TppGroup
      ...
      DataPipelineName = 'pPagarReceber'
      NewFile = False
      object pCabGrupoBenef: TppGroupHeaderBand
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        mmBottomOffset = 0
        mmHeight = 265
      ...
      object pRodapeGrupoBenef: TppGroupFooterBand
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        ...
        object ppLabel11: TppLabel
          ...
          Border.Weight = 1.000000000000000000
          Border.mmPadding = 0
          Caption = 'TOTAL DO BENEFICI'#193'RIO:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Name = 'Calibri'
          Font.Size = 6
    ...
    object ppGroup5: TppGroup
      ...
      object pRodapeGrupoClass: TppGroupFooterBand
        Visible = False
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        HideWhenOneDetail = False
        ...
        object ppLabel12: TppLabel
          ...
          Border.Weight = 1.000000000000000000
          Border.mmPadding = 0
          Caption = 'TOTAL DA CLASSIFICA'#199#195'O:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Name = 'Calibri'
          Font.Size = 6
    ...
    object ppGroup2: TppGroup
      ...
      object pRodaPeGrupoMes: TppGroupFooterBand
        Visible = False
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        HideWhenOneDetail = False
    ...
    object ppGroup4: TppGroup
      ...
      DataPipelineName = 'pPagarReceber'
      NewFile = False
      object gTitulo: TppGroupHeaderBand
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        mmBottomOffset = 0
        mmHeight = 0
      ...
      object gRodapeNumero: TppGroupFooterBand
        Visible = False
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        HideWhenOneDetail = False
