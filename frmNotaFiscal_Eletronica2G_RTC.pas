unit frmNotaFiscal_Eletronica2G_RTC;
...
type
    TNotaFiscal_Eletronica2G_RTC = class(TForm)
    Panel1: TPanel;
    bSair: TButton;
    bEnviar: TButton;
...
var
  NotaFiscal_Eletronica2G_RTC: TNotaFiscal_Eletronica2G_RTC;
...
procedure TNotaFiscal_Eletronica2G_RTC.bSairClick(Sender: TObject);
begin
      Close;
end;

procedure TNotaFiscal_Eletronica2G_RTC.FormClose(Sender: TObject;var Action: TCloseAction);
Var
   aINI:TIniFile;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.FormShow(Sender: TObject);
Var
   aINI:TIniFile;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.bEnviarClick(Sender: TObject);
Var
    mSel    : Integer;
    mParcela: Integer;
begin
...
Procedure TNotaFiscal_Eletronica2G_RTC.SalvarNFe;
var
   i
  ,mOrdem
  ,mReg: Integer;
...
procedure TNotaFiscal_Eletronica2G_RTC.GerarXML;
Var
...
begin
       ...
       With Dados, dmFiscal do begin
            ...
            if (ide_finNFe <> 4) or not TipoNotaIPI_Devolucao.AsBoolean  then begin
               ...
               ide := Util.identificadorRTC(ide_cUF
                                           ,ide_cNF
                                           ,ide_NatOP
                                           ,ide_Mode
                                           ,ide_Serie
...
Function TNotaFiscal_Eletronica2G_RTC.MontaDetalhe(item:integer; i:Integer; Qtde:double; Valor:double): string;
var
   Util: NFe_Util_2G_Interface;
   _produto,
   _DI,
      ...
      With Dados, dmFiscal do Begin
           ...
           if (ide_finNFE <> 4) or (not TipoNotaIPI_Devolucao.AsBoolean) then begin
              ...
              _produto := Util.produtoRTC(mCodigoProd                                                           // 01.informar o código do produto ou serviço.
                                         ...
                                         ,RemoveCaracterXML(PedidosItensUnidade_Medida.AsString)                // 12.informar a unidade de comercialização do produto.
                                         ,FormatFloat('0.0000', mQuantidade)                                    // 13.informar a quantidade de comercialização do produto.
           ...
           if (PedidosSaida_Entrada.Value = 0) or TipoNotaDevolucao_Importacao.AsBoolean then begin
           ...
           //Memo1.Lines.Add(floattostr(Roundto(PedidosItensValor_II.asfloat * (mQuantidade / ProdutosQuantidade_Unidade.AsFloat), -2)));
           //Memo1.Lines.Add(floattostr(Roundto(PedidosItensValor_AFRMM.asfloat * (mQuantidade / ProdutosQuantidade_Unidade.AsFloat), -4)));
           Memo1.Lines.Add(floattostr(Roundto(PedidosItensValor_Despesa.asfloat * PedidosItensQuantidade.asfloat, -4)));

           // IS
           _IS := util.IS_('000'                                 // Informar o Código de Situação Tributária do Imposto Seletivo, utilizar Tabela - CST.
                          ,'000'                                 // Informar o Código de Classificação Tributária do Imposto Seletivo, utilizar Tabela - cClassTrib.
                          ,0                                     // Informar o Valor da BC do Imposto Seletivo.
                          ,0                                     // Informar a Alíquota do Imposto Seletivo.
                          ,0                                     // Informar a Alíquota específica por unidade de medida apropriada.
                          ,''                                    // Informar a Unidade de Medida Tributável.As tags uTrib e qTrib serão geradas somente quando uTrib_Opc for informado.
                          ,0                                     // Informar a Quantidade Tributável Esta tag é gerada somente quando o uTrib_Opc for informado.
                          ,0);                                   // Informar o Valor do Imposto Seletivo.

           _IBSCBS := util.gIBSCBS(0                             // Informar a Base de cálculo do IBS e CBS.
                                  ,''                            // Informar o grupo gIBSUF.
                                  ,''                            // Informar o grupo gIBSMun gCBS.
                                  ,''                            // Informar o grupo gTribRegular.
                                  ,''                            // Informar o grupo gTribRegular.
                                  ,''                            // Informar o grupo gIBSCredPres.
                                  ,''                            // Informar o grupo gCBSCredPres.
                                  ,'');                          // Informar o grupo gTribCompraGov.
           
           if (ide_finNFE <> 4) or (not TipoNotaIPI_Devolucao.AsBoolean) then begin
              // Monta as TAGS de impostos dos produtos.
              _Imposto := Util.impostoNT2015003(PedidosItensTotal_Impostos.AsCurrency, _ICMS, _IPI, _II, _PIS, _PISST, _COFINS, _COFINSST, '', _ICMSUFDest);
              ...
              _Imposto := Util.impostoRTC(PedidosItensTotal_Impostos.AsCurrency
                                         ...
                                         ,''
                                         ,_ICMSUFDest
                                         ,'' //_IS                  // informar o grupo XML IS com o grupo de Tributação do IS - Imposto Seletivo.
                                         ,''); //_IBSCBS);            // informar o grupo XML IBSCBS com o grupo de Tributação do IBS - Imposto sobre Bens e Serviços e CBS - Contribição sobre Bens e Serviços.
                                   
              _Detalhe := Util.detalheRTC(Item
                                         ,_Produto
                                         ,_Imposto
                                         ,mDescricaoResto
                                         ,PedidosItensPercentual_IPIDevol.asfloat
                                         ,PedidosItensValor_IPIDevol.value
                                         ,''
                                         ,''
                                         ,0 //PedidosItensValor_Total.value
                                         ,'');
           end;
...
procedure TNotaFiscal_Eletronica2G_RTC.AssinarNFe;
var
    Util: NFe_Util_2G_Interface;
    MemoAssinado: TMemo;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.EnviarNFE;
var
   Util: NFe_Util_2G_Interface;
   mConsis: WideString;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.bDANFEClick(Sender: TObject);
begin
      DANFE_Retrato.AllowPrintToFile := True;
...
procedure TNotaFiscal_Eletronica2G_RTC.FormCreate(Sender: TObject);
begin
     FAPI := TServiceAPIDominio.Create;
     If FileExists('fundo_barra.bmp') then Image2.Picture.LoadFromFile('fundo_barra.bmp');
end;

procedure TNotaFiscal_Eletronica2G_RTC.FormDestroy(Sender: TObject);
begin
     if Assigned(FAPI) then FreeAndNil(FAPI);
end;

procedure TNotaFiscal_Eletronica2G_RTC.BuscarNFe;
var
    Util: NFe_Util_2G_Interface;
begin
      With Dados, dmFiscal do begin
...
procedure TNotaFiscal_Eletronica2G_RTC.ppDetailBand2BeforePrint(Sender: TObject);
begin
     lItem_CST.Caption := '';
...
procedure TNotaFiscal_Eletronica2G_RTC.ppHeaderBand1BeforePrint(Sender: TObject);
Var
    mParcela: Integer;
begin
      With Dados, dmFiscal do Begin
...
procedure TNotaFiscal_Eletronica2G_RTC.tTempoTimer(Sender: TObject);
begin
      mProcessamento := False;
      tTempo.Enabled := False;
end;

procedure TNotaFiscal_Eletronica2G_RTC.bSelecionarClick(Sender: TObject);
var
    vlLinha: Integer;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.bDesmarcarClick(Sender: TObject);
begin
      Grade.UnselectAll;
end;

procedure TNotaFiscal_Eletronica2G_RTC.ValidarXML;
var
   Util: NFe_Util_2G_Interface;
   mQtdeErrosXML,
   i, mTipo: integer;
...
procedure TNotaFiscal_Eletronica2G_RTC.EnviarEPEC;
var
    Util: NFe_Util_2G_Interface;
    ListaNFE
   ,dhEvento
...
procedure TNotaFiscal_Eletronica2G_RTC.BuscarChave;
var
    Util: NFe_Util_2G_Interface;
    mPosIni
   ,mPosFim
...
procedure TNotaFiscal_Eletronica2G_RTC.EnviarEmail(Tipo: String);
var
   mccList
...
procedure TNotaFiscal_Eletronica2G_RTC.DANFE_RetratoBeforePrint(Sender: TObject);
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.GeraDuplicatas(Tipo: Integer; Subsequente: Boolean; Dias: Integer; Classificacao: String; PercentualCambio: Real);
Var
    mValor           : Currency;
    mDataVenc        : TDate;
    mVenc            : String;
...
procedure TNotaFiscal_Eletronica2G_RTC.Consistencia;
begin
      with Dados, dmFiscal do begin
...
procedure TNotaFiscal_Eletronica2G_RTC.ItemGrade(Item: Integer; Tabela, Produto, NCM, Processo, Descricao: String);
begin
     with Dados do begin
          tErro.SQL.Clear;
...
procedure TNotaFiscal_Eletronica2G_RTC.PegaErros;
begin
      With Dados, dmFiscal do begin
           ErrosNFE.SQL.Clear;
...
procedure TNotaFiscal_Eletronica2G_RTC.GradeCellClick(Column: TColumn);
begin
     Grade.Enabled := false;
     Grade.UnselectAll;
     Grade.SelectedRows.CurrentRowSelected := True;
...
procedure TNotaFiscal_Eletronica2G_RTC.GradeDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
var
    Icon: TBitmap;
begin
      With Dados do begin
...
procedure TNotaFiscal_Eletronica2G_RTC.GradeKeyUp(Sender: TObject;var Key: Word; Shift: TShiftState);
begin
     PegaErros;
end;

procedure TNotaFiscal_Eletronica2G_RTC.GradeEditChange(Sender: TObject);
begin
     PegaErros;
end;

procedure TNotaFiscal_Eletronica2G_RTC.cProcessoChange(Sender: TObject);
begin
     FiltraPedidos;
end;

procedure TNotaFiscal_Eletronica2G_RTC.FiltraPedidos;
begin
     With Dados do begin
          Grade.DisableScroll;
          Pedidos.SQL.Clear;
...
procedure TNotaFiscal_Eletronica2G_RTC.cTipoClick(Sender: TObject);
begin
      FiltraPedidos;
end;

procedure TNotaFiscal_Eletronica2G_RTC.tContainersCalcFields(DataSet: TDataSet);
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.PageControl1Change(Sender: TObject);
begin
     bEnviar.Enabled := PageControl1.ActivePageIndex = 0;
end;

procedure TNotaFiscal_Eletronica2G_RTC.Button1Click(Sender: TObject);
Var
    mPesquisa : String;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.Button2Click(Sender: TObject);
Var
    mSel:integer;
begin
     with Dados do begin
...
procedure TNotaFiscal_Eletronica2G_RTC.bXMLClick(Sender: TObject);
Var
    mSel: Integer;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.GradeErrosCellClick(Column: TColumn);
Var
   mPedido: Integer;
   mSQL   : WideString;
begin
...
Function TNotaFiscal_Eletronica2G_RTC.MontaHistorico(Historico: integer):String;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.RegistraPasso(pPasso: string);
var
    Salva: boolean;
begin
      with Dados do begin
...
procedure TNotaFiscal_Eletronica2G_RTC.DuplicataDANFE(pParc:integer);
var
   Obj:TObject;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.ZerarDupl;
var
   Obj:TObject;
   i:Integer;
begin
...
procedure TNotaFiscal_Eletronica2G_RTC.BloqueiaEmissao(Tipo: Boolean);
begin
...
// Envia a nota fiscal eletrônica para o web service.
function TNotaFiscal_Eletronica2G_RTC.ConsultaContig: boolean;
var
   Util: NFe_Util_2G_Interface;
   cstat:integer;
begin
