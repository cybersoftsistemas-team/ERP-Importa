object Impressao_ProcessosOP_Navio: TImpressao_ProcessosOP_Navio
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Impressao_ProcessosOP_Navio'
  ClientHeight = 272
  ClientWidth = 671
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 220
    Height = 18
    Caption = 'Controle de estoque dos Navios/DI.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object rP01: TppReport
    ...
    PrinterSetup.DocumentName = 'Cybersoft - Controle de Estoque do Navio '
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = 'Controle de estoque por Navios/DI.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        Font.Size = 10
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object TotalEnt: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'TotalGeral1'
        AutoSize = False
        Border.mmPadding = 0
        BlankWhenZero = False
        CalcOrder = 1
      ...
      object TotalSai: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'TotalGeral2'
        AutoSize = False
        Border.mmPadding = 0
        BlankWhenZero = False
        CalcOrder = 2
    ...
    object ppGroup2: TppGroup
      ...
      object gCab_Produto: TppGroupHeaderBand
        BeforePrint = gCab_ProdutoBeforePrint
        Background.Brush.Style = bsClear
        Border.mmPadding = 0
        PrintHeight = phDynamic
        mmBottomOffset = 0
        ...
        object lSaldoIni: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'TotalGeral3'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 0
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupFooterBand1: TppGroupFooterBand
        ...
        object lTotalNavioEnt: TppDBCalc
          DesignLayer = ppDesignLayer1
          UserName = 'lTotalNavioEnt'
          Border.mmPadding = 0
          DataField = 'Entradas'
          DataPipeline = pItens
          DisplayFormat = ',##0.000'
        ...
        object lTotalNavioSai: TppDBCalc
          DesignLayer = ppDesignLayer1
          UserName = 'lTotalNavioSai'
          Border.mmPadding = 0
          DataField = 'Saidas'
          DataPipeline = pItens
          DisplayFormat = ',##0.000'
        ...
        object lTotalNavio: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'lTotalNavio'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 0
  ...
  object tItens: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,Codigo_Mercadoria'
        ...
        '      ,Descricao = cast((select substring(Descricao, 1, charinde' +
        'x('#39'<{'#39', Descricao)-1) from Produtos where Codigo = nin.Codigo_Me' +
        'rcadoria) as varchar(2000))'
      
        '      ,Unidade   = (select Unidade from Produtos where Codigo = ' +
        'nin.Codigo_Mercadoria)'
      '      ,Entradas  = iif(Saida_Entrada = 0, Quantidade, 0)'
      '      ,Saidas    = iif(Saida_Entrada = 0, 0, Quantidade)'
      
        '      ,Processo  = (select Processo from ControleNavios Cn where' +
        ' cn.Ordem = nin.Navio)'
      
        '      ,Navio_Nome= (select Navio from ControleNavios Cn where cn' +
        '.Ordem = nin.Navio)'
      '      ,Emissao   = iif(Emissor = '#39'P'#39', '#39'PROPRIO'#39', '#39'TERCEIROS'#39')'
  ...
  object tTmp: TMSQuery
    ...
    SQL.Strings = (
        ...
        'select Saldo = sum(iif(Saida_Entrada = 0, Quantidade, Quantidade' +
        ' *-1))'
      'from   NotasItensNavios nin'
