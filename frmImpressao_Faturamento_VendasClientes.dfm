object Impressao_Faturamento_VendasClientes: TImpressao_Faturamento_VendasClientes
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Impressao_Faturamento_VendasClientes'
  ClientHeight = 277
  ClientWidth = 658
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 295
    Height = 18
    Caption = 'Vendas efetuadas a Clientes por Representante.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cRepres: TRxDBLookupCombo
    Left = 104
    Top = 60
    Width = 538
    Height = 21
  ...
  object pVendas: TppDBPipeline
    DataSource = dstVendas
    CloseDataSource = True
    UserName = 'pVendas'
    Left = 510
    Top = 57
    object pVendasppField1: TppField
      Alignment = taRightJustify
    ...
    object pVendasppField2: TppField
      FieldAlias = 'Representante_Nome'
      FieldName = 'Representante_Nome'
      FieldLength = 60
      DisplayWidth = 60
    ...
    object pVendasppField3: TppField
      FieldAlias = 'Cliente_CNPJCPF'
      FieldName = 'Cliente_CNPJCPF'
      FieldLength = 18
      DisplayWidth = 18
      Position = 2
    end
    object pVendasppField4: TppField
    ...
    object pVendasppField5: TppField
    ...
    object pVendasppField6: TppField
      Alignment = taRightJustify
      FieldAlias = 'Vendas'
      FieldName = 'Vendas'
      FieldLength = 0
    ...
    object pVendasppField7: TppField
  ...
  object rVendas: TppReport
    ...
    Template.FileName = 
      'C:\Sistemas_XE\Faturamento\Codigo_Fonte\Relatorios\rVendas_Repre' +
      'sentante_CLientes.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        AutoSize = False
        Border.mmPadding = 0
        Caption = 'Vendas de Representantes/Clientes'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        Font.Size = 10
  ...
  object tVendas: TMSQuery
    ...
    SQL.Strings = (
      'select Representante'
        ...
        '      ,Cliente_CNPJCPF = case when isnull(Cliente_CNPJ, '#39#39') <> '#39 +
        #39' then'
      
        '                              substring(Cliente_CNPJ,1,2)+'#39'.'#39'+su' +
        'bstring(Cliente_CNPJ,3,3)+'#39'.'#39'+substring(Cliente_CNPJ,6,3)+'#39'/'#39'+su' +
        'bstring(Cliente_CNPJ,9,4)+'#39'-'#39'+substring(Cliente_CNPJ,13,2)'
      '                         else'
      
        #9'                      substring(Cliente_CPF,1,3)+'#39'.'#39'+substring(' +
        'Cliente_CPF,4,3)+'#39'.'#39'+substring(Cliente_CPF,7,3)+'#39'-'#39'+substring(Cl' +
        'iente_CPF,10,2)'
      '                         end'
      '      ,Cliente_Nome '
      '      ,Ultima_Compra = max(Data)'
      '      ,Vendas = count(Pedido)'
      '      ,Valor_Total = sum(Total_Pedido)'
      'from PedidosRepresentantes'
      'group by Representante, Cliente_CNPJ, Cliente_CPF, Cliente_Nome'
      'order by Representante_Nome, Cliente_Nome')
    FetchRows = 1
    Active = True
    Left = 433
    Top = 7
  end
  object dstVendas: TDataSource
    DataSet = tVendas
    Left = 432
    Top = 56
  end
