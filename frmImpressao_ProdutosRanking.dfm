object Impressao_ProdutosRanking: TImpressao_ProdutosRanking
  Left = 358
  Top = 253
  BorderStyle = bsDialog
  Caption = 'Impressao_ProdutosRanking'
  ClientHeight = 534
  ClientWidth = 681
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 196
    Height = 18
    Caption = 'Ranking de Vendas de Produtos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object tItens: TMSQuery
    ...
    SQL.Strings = (
      ...
      'WHERE  (Saida_Entrada = 1) AND (Cancelada <> 1)'
        ...
        'GROUP BY Codigo_Mercadoria, CAST(Descricao_Mercadoria AS VARCHAR' +
        '(500))'
  ...
  object rProdutosRanking: TppReport
    AutoStop = False
    DataPipeline = pItens
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\Produtos Ranking' +
      '.rtm'
    ...
    XLSSettings.ExportComponents = [ecText, ecLine, ecImage, ecRichText, ecBarCode, ecTable, ecOther]
    XLSSettings.IgnorePageHeight = True
    XLSSettings.IncludeSingleHeader = True
    XLSSettings.PreserveLineBreaks = True
    XLSSettings.Subject = 'Ranking de Produtos Vendidos'
    XLSSettings.Title = 'Ranking de Produtos Vendidos'
    XLSSettings.WorksheetName = 'Produtos'
    Left = 395
    Top = 278
    Version = '19.04'
    mmColumnWidth = 0
