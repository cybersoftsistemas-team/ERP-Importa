object Impressao_Estoque_FichaEstoque: TImpressao_Estoque_FichaEstoque
  Left = 668
  Top = 385
  BorderStyle = bsDialog
  Caption = 'Impressao_Estoque_FichaEstoque'
  ClientHeight = 252
  ClientWidth = 845
  Color = clBtnFace
  ...
  object cMateria: TCheckBox
    Left = 18
    Top = 155
    Width = 194
    Height = 17
    Caption = 'Imprimir Materia Prima Relacionada'
    TabOrder = 9
  end
  object tSaldo: TMSQuery
    ...
    SQL.Strings = (
      ...
      'from   FichaEstoque'
        ...
        'where  Registro = (select max(Registro) from FichaEstoque where ' +
        'Codigo = 41 and Data < '#39'07/01/2022'#39')')
    FetchRows = 1
    Active = True
    Left = 495
    Top = 57
  ...
  object rFicha: TppReport
    ...
    PrinterSetup.DocumentName = 'Ficha de Estoque'
    ...
    object ppGroup1: TppGroup
      ...
      object CabecalhoGProduto: TppGroupHeaderBand
        ...
        object pQtde_Inicial: TppVariable
          ...
          Font.Size = 6
          Font.Style = [fsBold]
          OldOnCalc = pQtde_InicialOldOnCalc
          TextAlignment = taRightJustified
          Transparent = True
          mmHeight = 2646
          mmLeft = 229660
  ...
  object pEstoque: TppDBPipeline
    DataSource = Dados.dsFichaEstoque
    UserName = 'pEstoque'
    Left = 350
    Top = 57
  ...
  object pSaldo: TppDBPipeline
    ...
    object pSaldoppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'Unitario_Saldo'
      FieldName = 'Unitario_Saldo'
      FieldLength = 0
    ...
    object pSaldoppField3: TppField
      FieldAlias = 'Total_Saldo'
      FieldName = 'Total_Saldo'
      FieldLength = 0
      DataType = dtCurrency
