object Impressao_FinanceirosOP_PagarReceberSimp: TImpressao_FinanceirosOP_PagarReceberSimp
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Impressao_FinanceirosOP_PagarReceberSimp'
  ClientHeight = 385
  ClientWidth = 743
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 337
    Height = 18
    Caption = 'Rela'#231#227'o de Pagamentos/Recebimentos. (Simplificada)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cAdianta: TCheckBox
    Left = 19
    Top = 289
    Width = 216
    Height = 17
    Caption = 'N'#227'o Listar lan'#231'amentos de Adiantamento'
    TabOrder = 10
  end
  ...
  object cEmpresas: TCheckListBox
    Left = 143
    Top = 111
    Width = 515
    Height = 57
  ...
  object cTipoBaixa: TRadioGroup
    ...
    ItemIndex = 0
    Items.Strings = (
      'Considerar Baixas fora do Per'#237'odo'
      'N'#227'o Considerar Baixas fora do Per'#237'odo')
    TabOrder = 14
  end
  object cValor: TRadioGroup
    Left = 564
    Top = 180
    Width = 103
    Height = 86
  ...
  object tTitulos: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,pr.Tipo'
      '      ,pr.Data_Vencimento'
      '      ,Dia = Day(pr.Data_Vencimento)'
      '      ,Mes = month(pr.Data_Vencimento)'
      '      ,Ano= year(pr.Data_Vencimento)'
      '      ,Class_Codigo = Classificacao'
      
        '      ,Class_Nome = (select Descricao from Cybersoft_Cadastros.d' +
        'bo.ClassificacaoFinanceira as cf where cf.Codigo = pr.Classifica' +
        'cao)'
      '      ,Beneficiario = case pr.Tipo'
      
        '                           when '#39'P'#39' then iif(isnull(pr.Fornecedo' +
        'r, 0) <> 0, (select Nome from Fornecedores where Codigo = pr.For' +
        'necedor), (select Nome from Cybersoft_Cadastros.dbo.OrgaosPublic' +
        'os where Codigo = pr.Orgao))'
      
        '                           when '#39'R'#39' then (select Nome from Clien' +
        'tes where Codigo = pr.Cliente)'
      '                      end'
      '      ,pr.Numero_Documento'
      '      ,pr.Valor_Total'
      '      ,pr.Observacao'
      '      ,pr.Processo'
      '      ,pr.Empresa'
      '      ,Filial = isnull(pr.Filial, 0)'
      
        '      ,Nome_Filial = iif( (select Numero_Filial from Cybersoft_C' +
        'adastros.dbo.Empresas where Codigo = Empresa) = 0 , '#39'MATRIZ'#39', '#39'F' +
        'ILIAL '#39'+(select cast(Numero_Filial as char(3)) from Cybersoft_Ca' +
        'dastros.dbo.Empresas where Codigo = Empresa))'
      'into #temp'
      'from PagarReceber pr'
      'where pr.Nivel <= 10'
      'and pr.Data_Vencimento between '#39'09/01/2025'#39' AND '#39'10/30/2025'#39
      
        'and isnull((select Relatorio from Cybersoft_Cadastros.dbo.Classi' +
        'ficacaoFinanceira as cf where pr.Classificacao = cf.Codigo), 0) ' +
        '<> 1'
      
        'and isnull((select Somente_Faturamento from Cybersoft_Cadastros.' +
        'dbo.ClassificacaoFinanceira where Codigo = Classificacao), 0) <>' +
        ' 1'
      'select * from #temp'
      
        'order by Nome_Filial desc, Ano, Mes, Data_Vencimento, Beneficiar' +
        'io'
      'drop table #temp'
      '')
    FetchRows = 1
  ...
  object rPagRecSimp: TppReport
    AutoStop = False
    DataPipeline = pPagarReceber
    NoDataBehaviors = [ndBlankReport]
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Contas a pagar / Receber (Simplificado)'
    ...
    Template.FileName = 
      'C:\Sistemas_XE\Faturamento\Codigo_Fonte\Relatorios\FinanceirosPa' +
      'garReceberSimp.rtm'
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = 'Rela'#231#227'o de contas pagar (Simplificado)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
    ...
    object ppDetailBand1: TppDetailBand
      ...
      Background2.Brush.Color = 16772332
      Border.mmPadding = 0
      PrintHeight = phDynamic
      mmBottomOffset = 0
      mmHeight = 2540
    ...
    object ppSummaryBand1: TppSummaryBand
      Background.Brush.Style = bsClear
      Background.Gradient.StartColor = 10192533
      Border.mmPadding = 0
      mmBottomOffset = 0
      mmHeight = 5080
      mmPrintPosition = 0
    ...
    object ppGroup3: TppGroup
      ...
      object pRodaPeGrupoEmpresa: TppGroupFooterBand
        BeforePrint = pRodaPeGrupoEmpresaBeforePrint
        Background.Brush.Style = bsClear
        Background.Gradient.EndColor = clBlack
        Background.Gradient.StartColor = clNone
        Border.mmPadding = 0
        HideWhenOneDetail = False
        mmBottomOffset = 0
        mmHeight = 7112
        mmPrintPosition = 0
        object lTotalEmpresa: TppLabel
          DesignLayer = ppDesignLayer1
          UserName = 'Label18'
          AutoSize = False
          Border.Weight = 1.000000000000000000
          Border.mmPadding = 0
          Caption = 'TOTAL DA FILIAL'
          Color = 7884319
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWhite
          Font.Name = 'Calibri'
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupFooterBand1: TppGroupFooterBand
        ...
        Background.Brush.Style = bsClear
        Background.Gradient.StartColor = clBlack
        Border.mmPadding = 0
        HideWhenOneDetail = False
        mmBottomOffset = 0
        mmHeight = 7112
        mmPrintPosition = 0
        object lTotalMes: TppLabel
          DesignLayer = ppDesignLayer1
          UserName = 'Label8'
          AutoSize = False
          Border.Weight = 1.000000000000000000
    ...
    object ppGroup1: TppGroup
      ...
      object pRodapeGrupoDia: TppGroupFooterBand
        BeforePrint = pRodapeGrupoDiaBeforePrint
        Background.Brush.Style = bsClear
        Background.Gradient.EndColor = clSilver
        Background.Gradient.StartColor = clNone
  ...
  object pPagarReceber: TppDBPipeline
    ...
    object pPagarReceberppField7: TppField
      FieldAlias = 'Class_Codigo'
      FieldName = 'Class_Codigo'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 6
    ...
    object pPagarReceberppField8: TppField
      FieldAlias = 'Class_Nome'
      FieldName = 'Class_Nome'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 7
  ...
  object tEmpresas: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,Tipo'
      '      ,Data_Vencimento'
      '      ,Benef = isnull(iif(Tipo = '#39'P'#39', Fornecedor, Cliente), 0)'
      
        '      ,Beneficiario = isnull(iif(Tipo = '#39'P'#39', (select Nome from F' +
        'ornecedores where Codigo = Fornecedor), (select Nome from Client' +
        'es where Codigo = Cliente)), 11)'
      '      ,Data_Documento'
      '      ,Numero_Documento'
      '      ,Valor_Documento'
      '      ,Valor_Total'
      '      ,Observacao'
        ...
        '      ,Empresa = (select Codigo from Cybersoft_Cadastros.dbo.Emp' +
        'resas)'
      'from PagarReceber'
      'order by Data_Vencimento, Numero')
    FetchRows = 1
    Left = 418
    Top = 291
  end
