object Impressao_FinanceirosOP_ComissaoTrader: TImpressao_FinanceirosOP_ComissaoTrader
  Left = 545
  Top = 349
  BorderStyle = bsDialog
  Caption = 'Impressao_FinanceirosOP_ComissaoTrader'
  ClientHeight = 229
  ClientWidth = 487
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 257
    Height = 18
    Caption = 'Rela'#231#227'o de comisso'#245'es a pagar a Traders.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cTrader: TRxDBLookupCombo
    Left = 79
    Top = 81
    Width = 396
    Height = 21
    ...
    ParentFont = False
    TabOrder = 2
    OnChange = cTraderChange
    OnKeyDown = cTraderKeyDown
  end
  ...
  object rFinanceiro_Traders: TppReport
    AutoStop = False
    DataPipeline = pNotas
    NoDataBehaviors = [ndMessageDialog, ndBlankPage]
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Comiss'#245'es a Pagar a Trader.'
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\Financeiro_Trade' +
      'rs.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        AutoSize = False
        Border.mmPadding = 0
        Caption = 'Comiss'#245'es a pagar a Trader'#39's'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object cTotalNF: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cTotalNFTrader1'
        AutoSize = False
        Border.mmPadding = 0
        BlankWhenZero = False
        CalcOrder = 1
      ...
      object cTotalBC: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'cTotalBCTrader1'
        AutoSize = False
        Border.mmPadding = 0
        BlankWhenZero = False
        CalcOrder = 2
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupFooterBand1: TppGroupFooterBand
        ...
        object cPagoTrader: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'cPago1'
          AutoSize = False
          Border.mmPadding = 0
        ...
        object cTotalNFTrader: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'cTotalNFTrader'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 1
        ...
        object cTotalBCTrader: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'cTotalBCTrader'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 2
  ...
  object pNotas: TppDBPipeline
    ...
    object pNotasppField4: TppField
      FieldAlias = 'Nome_Trader'
      FieldName = 'Nome_Trader'
      FieldLength = 60
      DisplayWidth = 60
      Position = 3
    end
  ...
  object tNotas: TMSQuery
    ...
    SQL.Strings = (
      ...
      '       Clientes.Trader, '
        ...
        '       (SELECT Nome FROM Fornecedores WHERE(Trader = Fornecedore' +
        's.Codigo)) AS Nome_Trader,'
      '       Clientes.Trader_Comissao,'
      '       Numero, '
      '       Data_Emissao, '
      '       Valor_TotalNota, '
      '       BCICMS, '
      '       Processo,'
      '       Clientes.Tipo_Comissao,'
      '       0 AS Negociacao'
      'FROM   NotasFiscais, Clientes'
      'WHERE  (Saida_Entrada = 1) '
      '       AND (CLientes.Codigo = Cliente_Codigo) '
      '       AND (Clientes.Trader IS NOT NULL)'
