object Processo_RegistroDUIMP: TProcesso_RegistroDUIMP
  Left = 343
  Top = 154
  BorderStyle = bsDialog
  Caption = 'Processo_RegistroDUIMP'
  ClientHeight = 604
  ClientWidth = 1056
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 334
    Height = 19
    Caption = 'Registro da Declara'#231#227'o Unica de Importa'#231#227'o (DUIMP)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object pPasta: TPageControl
    ...
    object tDadosDI: TTabSheet
      ...
      object RxDBComboBox5: TRxDBComboBox
        ...
        Font.Style = [fsBold]
        Items.Strings = (
          'BL('#8220'bill of lading'#8221')'
          'HBL('#8220'house bill of lading'#8221')'
          'AWB ('#8220'airway bill'#8221')'
          'HAWB('#8220'house airway bill'#8221')'
          'DSIC (documento subsidi'#225'rio)'
          'CRT'
          'RWB('#8220'railway bill'#8221')'
          'HRWB('#8220'house railway bill'#8221')'
          'TIF/DTA'
          'C'#243'digo de barra')
        ParentFont = False
        TabOrder = 19
