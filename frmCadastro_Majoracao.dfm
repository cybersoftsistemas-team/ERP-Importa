object Cadastro_Majoracao: TCadastro_Majoracao
  Left = 557
  Top = 315
  BorderStyle = bsDialog
  Caption = 'Cadastro_Majoracao'
  ClientHeight = 704
  ClientWidth = 597
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 327
    Height = 18
    Caption = 'Manuten'#231#227'o da tabela de Al'#237'quotas de PIS e COFINS.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
