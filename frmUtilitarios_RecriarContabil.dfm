object Utilitarios_RecriarContabil: TUtilitarios_RecriarContabil
  Left = 406
  Top = 157
  ActiveControl = cDataIni
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsDialog
  Caption = 'Utilitarios_RecriarContabil'
  ClientHeight = 574
  ClientWidth = 994
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 416
    Height = 18
    Caption = 'Gera'#231#227'o dos lan'#231'amentos contabeis (Contas pelo Tipo de Processo)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
