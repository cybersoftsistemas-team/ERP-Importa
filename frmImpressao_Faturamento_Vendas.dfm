object Impressao_Faturamento_Vendas: TImpressao_Faturamento_Vendas
  Left = 561
  Top = 290
  BorderStyle = bsDialog
  Caption = 'Impressao_Faturamento_Vendas'
  ClientHeight = 241
  ClientWidth = 728
  Color = clBtnFace
  ...
  object tItens: TMSQuery
    ...
    SQL.Strings = (
      ...
      'INTO #Temp'
      'FROM NotasItens'
      'WHERE Codigo_Mercadoria = 83'
      'SELECT Codigo, '
      
        '       (SELECT Codigo_Fabricante FROM Produtos WHERE(Codigo = #T' +
        'emp.Codigo)) AS Codigo_Fabricante,'
      
        '       (SELECT REPLACE(Descricao, '#39'<{'#39'+LTRIM(RTRIM(CAST(#Temp.Co' +
        'digo AS VARCHAR(10))))+'#39'}>'#39', '#39#39') FROM Produtos WHERE(Codigo = #T' +
        'emp.Codigo)) AS Descricao,'
      '       SUM(Quantidade) AS Quantidade,'
      '       SUM(Valor_Total) AS Valor_Total,'
      '       Mes,'
      '       CASE WHEN Mes =  1 THEN '#39'JANEIRO'#39
      '            WHEN Mes =  2 THEN '#39'FEVEREIRO'#39
      '            WHEN Mes =  3 THEN '#39'MAR'#199'O'#39
  ...
  object rVendas: TppReport
    ...
    BeforePrint = rVendasBeforePrint
    DeviceType = 'Screen'
