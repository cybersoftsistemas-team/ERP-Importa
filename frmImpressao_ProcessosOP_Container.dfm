object Impressao_ProcessosOP_Container: TImpressao_ProcessosOP_Container
  Left = 499
  Top = 260
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 229
    Height = 18
    Caption = 'Impress'#227'o do controle de containers.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cProcesso: TDBLookupComboBox
    ...
    Font.Style = [fsBold]
    KeyField = 'Processo'
    ListField = 'Processo;Processo_Abertura'
  ...
  object pDemurrage: TppDBPipeline
    ...
    Left = 416
    Top = 44
    object pDemurrageppField1: TppField
      FieldAlias = 'Numero'
      FieldName = 'Numero'
      FieldLength = 20
      DisplayWidth = 20
    ...
    object pDemurrageppField2: TppField
      FieldAlias = 'Processo'
      FieldName = 'Processo'
      FieldLength = 15
      DisplayWidth = 15
    ...
    object pDemurrageppField3: TppField
    ...
    object pDemurrageppField4: TppField
    ...
    object pDemurrageppField5: TppField
      FieldAlias = 'Hora_Entrada'
      FieldName = 'Hora_Entrada'
      FieldLength = 8
      DisplayWidth = 8
      Position = 4
    end
    object pDemurrageppField6: TppField
    ...
    object pDemurrageppField7: TppField
      FieldAlias = 'Hora_Saida'
      FieldName = 'Hora_Saida'
      FieldLength = 8
      DisplayWidth = 8
      Position = 6
    end
    object pDemurrageppField8: TppField
      Alignment = taRightJustify
    ...
    object pDemurrageppField9: TppField
      FieldAlias = 'Valor_Demurrage'
    ...
    object pDemurrageppField10: TppField
      FieldAlias = 'Tipo'
      FieldName = 'Tipo'
      FieldLength = 30
      DisplayWidth = 30
    ...
    object pDemurrageppField11: TppField
      Alignment = taRightJustify
      FieldAlias = 'Tamanho'
      FieldName = 'Tamanho'
      FieldLength = 0
    ...
    object pDemurrageppField12: TppField
      FieldAlias = 'Armador'
      FieldName = 'Armador'
      FieldLength = 50
      DisplayWidth = 50
    ...
    object pDemurrageppField13: TppField
    ...
    object pDemurrageppField14: TppField
      FieldAlias = 'Terminal'
      FieldName = 'Terminal'
      FieldLength = 50
      DisplayWidth = 50
    ...
    object pDemurrageppField15: TppField
    ...
    object pDemurrageppField16: TppField
      FieldAlias = 'Hora_Entrega'
      FieldName = 'Hora_Entrega'
      FieldLength = 8
      DisplayWidth = 8
      Position = 15
    end
    object pDemurrageppField17: TppField
      Alignment = taRightJustify
      FieldAlias = 'Transportadora_Entrada'
      FieldName = 'Transportadora_Entrada'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 16
    end
    object pDemurrageppField18: TppField
      Alignment = taRightJustify
      FieldAlias = 'Transportadora_Saida'
      FieldName = 'Transportadora_Saida'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 17
    end
    object pDemurrageppField19: TppField
    ...
    object pDemurrageppField20: TppField
      FieldAlias = 'Tipo_Embarque'
      FieldName = 'Tipo_Embarque'
      FieldLength = 15
      DisplayWidth = 15
      Position = 19
    end
    object pDemurrageppField21: TppField
      FieldAlias = 'Memo_Processos'
      FieldName = 'Memo_Processos'
      FieldLength = 0
      DataType = dtMemo
      DisplayWidth = 10
      Position = 20
    ...
    object pDemurrageppField22: TppField
  ...
  object rContainer: TppReport
    ...
    PrinterSetup.DocumentName = 'Processo - Controle de Demurrage'
    ...
    Template.FileName = 'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\Demurrage.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        AutoSize = False
        Border.mmPadding = 0
        Caption = 'Controle de containers (Demurrage)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        Font.Size = 12
        ...
        object ppChildReport1: TppChildReport
          ...
          object ppDetailBand2: TppDetailBand
            ...
            object ppDBText12: TppDBText
              ...
              UserName = 'DBText12'
              Border.mmPadding = 0
              DataField = 'TransportaEntrada_Nome'
              DataPipeline = pDemurrage
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Name = 'Calibri'
            ...
            object ppDBText13: TppDBText
              ...
              UserName = 'DBText13'
              Border.mmPadding = 0
              DataField = 'TransportaSaida_Nome'
              DataPipeline = pDemurrage
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Name = 'Calibri'
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      mmHeight = 10319
      mmPrintPosition = 0
      object rTotalDemurrage: TppDBCalc
        DesignLayer = ppDesignLayer2
        UserName = 'rTotalDemurrage'
        Border.mmPadding = 0
        DataField = 'Valor_Container'
        DataPipeline = pDemurrage
        DisplayFormat = ',##0.00'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
  ...
  object tContainer: TMSQuery
    ...
    SQL.Strings = (
      'select *'
        ...
        '      ,Dias = iif(isnull(Data_Entrega, '#39#39') <> '#39#39', datediff(Day, ' +
        'Data_Saida, Data_Entrega), datediff(Day, Data_Saida, getdate()))'
      
        '      ,Valor_Container = Valor_Demurrage * (iif(isnull(Data_Entr' +
        'ega, '#39#39') <> '#39#39', datediff(Day, Data_Saida, Data_Entrega), datedif' +
        'f(Day, Data_Saida, getdate())))'
      
        '      ,(select Nome from Fornecedores frn where frn.Codigo = ctn' +
        '.Armazem) as Armazem_Nome'
      
        '      ,(select Nome from Fornecedores frn where frn.Codigo = ctn' +
        '.Transportadora_Entrada) as TransportaEntrada_Nome'
  ...
  object dstContainer: TDataSource
    DataSet = tContainer
    Left = 270
    Top = 61
  end
