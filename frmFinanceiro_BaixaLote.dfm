object Financeiro_BaixaLote: TFinanceiro_BaixaLote
  Left = 493
  Top = 276
  ...
  object lTitulo: TRxLabel
    ...
    Width = 153
    Height = 18
    Caption = 'Baixa de t'#237'tulos por lote.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cFiltro: TGroupBox
    ...
    object cSelecionar: TCheckBox
      ...
      Caption = 'Selecionar registros filtrados'
      TabOrder = 3
    end
    ...
    object cComissao: TCheckBox
      Left = 618
      Top = 109
      Width = 184
      Height = 17
      Alignment = taLeftJustify
      Caption = 'Comiss'#245'es com T'#237'tulos Liquidados'
      TabOrder = 11
    end
  ...
  object tTitulos: TMSQuery
    ...
    SQL.Strings = (
      ...
      '       END AS Beneficiario,'
        ...
        '       CASE WHEN Fornecedor <> 0    THEN ( SELECT isnull(CNPJ, '#39 +
        #39#39#39')+isnull(CPF,'#39#39#39#39') FROM Fornecedores WHERE (Fornecedores.Codi' +
        'go = Fornecedor) )'
      
        '            WHEN Cliente    <> 0    THEN ( SELECT isnull(CNPJ, '#39 +
        #39#39#39')+isnull(CPF,'#39#39#39#39') FROM Clientes     WHERE (Clientes.Codigo  ' +
        '   = Cliente) )'
      ...
      '       Forma_Tipo,'
      '       Numero_FormaTipo,'
      '       CAST(Observacao AS VARCHAR(500)) AS Obs_Titulo'
      'FROM   PagarReceber'
      '--WHERE (Valor_Baixado < Valor_Parcela OR Valor_Baixado IS NULL)'
      
        '--      AND (PagarReceber.Tipo = '#39'P'#39') AND (PagarReceber.Numero =' +
        ' 1)'
    ...
    object tTitulosForma_Tipo: TStringField
      FieldName = 'Forma_Tipo'
      Origin = 'PagarReceber.Forma_Tipo'
      Size = 25
    end
    object tTitulosNumero_FormaTipo: TStringField
      FieldName = 'Numero_FormaTipo'
      Origin = 'PagarReceber.Numero_FormaTipo'
      Size = 15
    end
    object tTitulosObs_Titulo: TStringField
      FieldName = 'Obs_Titulo'
      Origin = '.'
      ReadOnly = True
      Size = 500
    end
    object tTitulosCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
      ReadOnly = True
      Size = 50
    end
