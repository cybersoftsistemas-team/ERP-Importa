object Impressao_Processos_PrevisaoDespesas: TImpressao_Processos_PrevisaoDespesas
  Left = 432
  Top = 211
  BorderStyle = bsDialog
  Caption = 'Impressao_Processos_PrevisaoDespesas'
  ClientHeight = 199
  ClientWidth = 379
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 212
    Height = 18
    Caption = 'Previs'#227'o de Despesa de Processos.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cPrevisao: TCheckBox
    Left = 13
    Top = 114
    Width = 169
    Height = 22
    Caption = 'Incluir Previs'#227'o de faturamento.'
    TabOrder = 7
  end
  object tFluxo: TMSQuery
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
      'SELECT Data_PrevRegistro AS Data_Vencimento,'
      
        '       Cliente = (SELECT Nome FROM Clientes WHERE Codigo = Clien' +
        'te),'
      
        '       Fornecedor = (SELECT Nome FROM Fornecedores WHERE Codigo ' +
        '= Previsao_FreteTransportador),'
      
        '       Modalidade = (SELECT Descricao FROM TiposProcesso WHERE C' +
        'odigo = Modalidade_Importacao),'
      '       '#39'PREVIS'#195'O DE REGISTRO'#39' AS Classificacao,'
      '       Processo,'
      '       Centro_Custo = '#39#39','
      '       Fator_SISCOMEXValorReal AS Valor,'
      '       Empresa = 13,'
      '       Filial = CAST('#39#39' AS VARCHAR(15)),'
      '       Tipo = '#39'RG'#39
      'FROM   ProcessosDocumentos PD'
      'WHERE  Data_PrevRegistro BETWEEN '#39'01/01/2013'#39' AND '#39'12/31/2013'#39
      
        'AND    (SELECT COUNT(*) FROM NotasItens NI WHERE NI.Processo = P' +
        'D.Processo AND NI.Saida_Entrada = 1) = 0')
    FetchRows = 1
    Active = True
    Left = 275
    Top = 110
