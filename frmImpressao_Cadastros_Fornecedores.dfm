object Impressao_Cadastros_Fornecedores: TImpressao_Cadastros_Fornecedores
  Left = 636
  Top = 293
  BorderStyle = bsDialog
  Caption = 'Impressao_Cadastros_Fornecedores'
  ClientHeight = 317
  ClientWidth = 387
  Color = clBtnFace
  ...
  object cRamo: TRxDBLookupCombo
    ...
    LookupSource = Dados.dsRamoAtividade
    ParentFont = False
    TabOrder = 2
  end
  ...
  object rFornecedores: TppReport
    AutoStop = False
    DataPipeline = pFornecedores
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Cybersoft - Cadastro de Fornecedores'
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\Cadastro_Fornece' +
      'dores.rtm'
    ...
    Version = '19.04'
    mmColumnWidth = 0
    DataPipelineName = 'pFornecedores'
  ...
  object pFornecedores: TppDBPipeline
    DataSource = dstFornecedores
    CloseDataSource = True
    UserName = 'pFornecedores'
    Left = 248
    Top = 184
  end
  ...
  object tFornecedores: TMSQuery
    ...
    SQL.Strings = (
      ...
      '     ,Telefone1'
        ...
        '     , Pais_Nome = (SELECT Nome FROM Cybersoft_Cadastros.dbo.Pai' +
        'ses WHERE Codigo = Pais)'
      'FROM   Fornecedores'
  ...
  object rExcel: TppReport
    ...
    PrinterSetup.mmMarginRight = 6350
    PrinterSetup.mmMarginTop = 6350
    PrinterSetup.mmPaperHeight = 25400051
    PrinterSetup.mmPaperWidth = 210000
    ...
    TextFileName = '($MyDocuments)\Cadastro_Fornecedores.xlsx'
    TextSearchSettings.DefaultString = '<Texto a localizar>'
    TextSearchSettings.Enabled = True
    ...
    XLSSettings.Subject = 'Cadastro de Fornecedores'
    XLSSettings.Title = 'Cadastro de Fornecedores'
    XLSSettings.WorksheetName = 'Fornecedores'
    Left = 320
    Top = 136
    Version = '19.04'
    mmColumnWidth = 0
