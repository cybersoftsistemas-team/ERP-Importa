object Cadastro_Recebedor: TCadastro_Recebedor
  Left = 517
  Top = 268
  BorderStyle = bsDialog
  Caption = 'Cadastro_Recebedor'
  ClientHeight = 323
  ClientWidth = 639
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 245
    Height = 18
    Caption = 'Manuten'#231#227'o da tabela de Recebedores.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object Panel1: TPanel
    ...
    object Navega: TDBNavigator
      ...
      Height = 28
      Cursor = crHandPoint
      DataSource = Dados.dsRecebedores
  ...
  object tCodigo: TMSQuery
    ...
    SQL.Strings = (
      'SELECT MAX(Codigo) AS Codigo FROM Recebedores')
    Left = 272
    Top = 8
  end
