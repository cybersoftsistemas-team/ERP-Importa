object Impressao_FiscaisOP_LivroServicoTomado: TImpressao_FiscaisOP_LivroServicoTomado
  Left = 486
  Top = 258
  BorderStyle = bsDialog
  Caption = 'Impressao_Fiscais_NotasServicoPrestados'
  ClientHeight = 253
  ClientWidth = 593
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 276
    Height = 18
    Caption = 'Rela'#231#227'o de notas fiscais de Servi'#231'o Tomados.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cRetencao: TRadioGroup
    Left = 8
    Top = 117
    Width = 352
    Height = 46
    Caption = 'Reten'#231#227'o ISS'
    Columns = 3
    Items.Strings = (
      'Todos'
      'Com reten'#231#227'o'
  ...
  object rServicos: TppReport
    AutoStop = False
    DataPipeline = pNotas
    NoDataBehaviors = [ndBlankReport]
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Fiscal - Rela'#231#227'o de Notas Fiscais de Servi'#231'os Tomados.'
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo_Fonte\Relatorios\Rela'#231#227'o de Notas' +
      ' Fiscais_Servico_Tomados.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lTitulo: TppLabel
        ...
        Border.Weight = 1.000000000000000000
        Border.mmPadding = 0
        Caption = 'RELA'#199#195'O DE NOTAS FISCAIS DE SERVI'#199'O TOMADOS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
  ...
  object pNotas: TppDBPipeline
    ...
    object pNotasppField9: TppField
      FieldAlias = 'Valor_BCISS'
      FieldName = 'Valor_BCISS'
      FieldLength = 0
      DataType = dtCurrency
      DisplayWidth = 10
      Position = 8
    ...
    object pNotasppField12: TppField
      Alignment = taRightJustify
      FieldAlias = 'Valor_IsentasISS'
      FieldName = 'Valor_IsentasISS'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 11
    ...
    object pNotasppField13: TppField
      FieldAlias = 'Valor_OutrasISS'
      FieldName = 'Valor_OutrasISS'
      FieldLength = 0
      DataType = dtCurrency
      DisplayWidth = 10
      Position = 12
    ...
    object pNotasppField15: TppField
      FieldAlias = 'Codigo_ISS'
      FieldName = 'Codigo_ISS'
      FieldLength = 1
      DisplayWidth = 1
      Position = 14
    end
  ...
  object tNotas: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,Data_Entrada'
        ...
        '= Fornecedor)'
      '      ,Serie'
      '      ,Dia = DAY(Data_Entrada)'
      '      ,Estado'
      '      ,Valor_TotalNota'
      '      ,Natureza_Codigo'
      
        '      ,Valor_BCISS = CASE WHEN (SELECT Regime_Apuracao FROM Cybe' +
        'rsoft_Cadastros.dbo.Empresas WHERE Codigo = 59) = 3 THEN Valor_T' +
        'otalNota ELSE 0 END'
      '      ,Aliquota_ISS'
      '      ,Valor_ISS'
      '      ,Valor_IsentasISS = 0'
      
        '      ,Valor_OutrasISS = CASE WHEN (SELECT Regime_Apuracao FROM ' +
        'Cybersoft_Cadastros.dbo.Empresas WHERE Codigo = 59) = 1 THEN Val' +
        'or_TotalNota ELSE 0 END'
      '      ,Observacoes'
      
        '      ,Codigo_ISS = CASE WHEN (SELECT Regime_Apuracao FROM Cyber' +
        'soft_Cadastros.dbo.Empresas WHERE Codigo = 59) = 1 THEN '#39'3'#39' ELSE' +
        ' '#39'1'#39' END'
      'FROM   NotasTerceiros '
      'WHERE  Servico IS NOT NULL'
      'ORDER BY Data_Entrada, Nota')
    Active = True
    Left = 338
    Top = 9
  end
  ...
  object tTotais: TMSQuery
    ...
    SQL.Strings = (
      '--USE Cybersoft_ALI_Matriz'
      'SELECT Codigo = Codigo_Adicional01'
      '      ,Valor = SUM(Valor_Adicional01)'
      'INTO #TEMP       '
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional01 IS NOT NULL AND' +
        ' Codigo_Adicional01 IS NOT NULL'
      'GROUP BY Codigo_Adicional01'
      'UNION ALL'
      'SELECT Codigo = Codigo_Adicional02'
      '      ,Valor = SUM(Valor_Adicional02)'
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional02 IS NOT NULL AND' +
        ' Codigo_Adicional02 IS NOT NULL'
      'GROUP BY Codigo_Adicional02'
      'UNION ALL'
      'SELECT Codigo = Codigo_Adicional03'
      '      ,Valor = SUM(Valor_Adicional03)'
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional03 IS NOT NULL AND' +
        ' Codigo_Adicional03 IS NOT NULL'
      'GROUP BY Codigo_Adicional03'
      'UNION ALL'
      'SELECT Codigo = Codigo_Adicional04'
      '      ,Valor = SUM(Valor_Adicional04)'
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional04 IS NOT NULL AND' +
        ' Codigo_Adicional04 IS NOT NULL'
      'GROUP BY Codigo_Adicional04'
      'UNION ALL'
      'SELECT Codigo = Codigo_Adicional05'
      '      ,Valor = SUM(Valor_Adicional05)'
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional05 IS NOT NULL AND' +
        ' Codigo_Adicional05 IS NOT NULL'
      'GROUP BY Codigo_Adicional05'
      'UNION ALL'
      'SELECT Codigo = Codigo_Adicional06'
      '      ,Valor = SUM(Valor_Adicional06)'
      'FROM   NotasTerceiros '
      
        'WHERE  Servico IS NOT NULL AND Valor_Adicional06 IS NOT NULL AND' +
        ' Codigo_Adicional06 IS NOT NULL'
      'GROUP BY Codigo_Adicional06'
      ''
      'SELECT Codigo'
      
        '      ,Descricao = (SELECT Descricao FROM Cybersoft_Cadastros.db' +
        'o.Impostos Imp WHERE Imp.Codigo = #Temp.Codigo) '
      '      ,Valor = SUM(Valor) '
      'FROM  #TEMP '
      'GROUP BY Codigo '
      'ORDER BY Codigo'
  ...
  object pTotais: TppDBPipeline
    DataSource = dstTotais
    UserName = 'Totais'
    Left = 490
    Top = 9
    object pTotaisppField1: TppField
      FieldAlias = 'Codigo'
      FieldName = 'Codigo'
      FieldLength = 10
      DisplayWidth = 10
    ...
    object pTotaisppField2: TppField
    ...
    object pTotaisppField3: TppField
      FieldAlias = 'Valor'
      FieldName = 'Valor'
      FieldLength = 0
      DataType = dtCurrency
