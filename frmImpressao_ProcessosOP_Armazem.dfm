object Impressao_ProcessosOP_Armazem: TImpressao_ProcessosOP_Armazem
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Impressao_ProcessosOP_Armazem'
  ClientHeight = 229
  ClientWidth = 671
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 215
    Height = 18
    Caption = 'Controle de estoque por Armaz'#233'm.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object Panel2: TPanel
    ...
    object cProduto: TDBLookupComboBox
      ...
      Font.Style = [fsBold]
      KeyField = 'Codigo'
      ListField = 'Descricao_Reduzida;Codigo'
      ListFieldIndex = 2
  ...
  object rArmazem: TppReport
    AutoStop = False
    DataPipeline = pItens
    NoDataBehaviors = [ndBlankReport]
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Estoque em Armazem'
    ...
    object ppDetailBand1: TppDetailBand
      ...
      Background1.Brush.Color = 15987699
      Background1.Gradient.EndColor = 16772332
      Background1.Gradient.StartColor = 16772332
      Background2.Brush.Style = bsClear
      Background2.Gradient.EndColor = 16380136
      Background2.Gradient.StartColor = 16380136
      Border.mmPadding = 0
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupHeaderBand3: TppGroupHeaderBand
        ...
        object SaldoEmpIni: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'SaldoEmpIni'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 0
        ...
        object SaldoArmIni: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'SaldoEmpIni1'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 1
  ...
  object pItens: TppDBPipeline
    ...
    object pItensppField10: TppField
      Alignment = taRightJustify
      FieldAlias = 'Finalidade_Cod'
      FieldName = 'Finalidade_Cod'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 9
    ...
    object pItensppField14: TppField
      Alignment = taRightJustify
      FieldAlias = 'Saldo_Empresa'
      FieldName = 'Saldo_Empresa'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 13
    ...
    object pItensppField15: TppField
      Alignment = taRightJustify
      FieldAlias = 'Saldo_Armazem'
      FieldName = 'Saldo_Armazem'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
      Position = 14
  ...
  object tItens: TMSQuery
    ...
    SQL.Strings = (
        ...
        'select Armazem = (select Armazem from NotasFiscais nf where nf.N' +
        'umero = ni.Nota and nf.Data_Emissao = ni.Data)'
      
        '      ,Armazem_Nome = (select Nome from Fornecedores fr where fr' +
        '.Codigo = (select Armazem from NotasFiscais nf where nf.Numero =' +
        ' ni.Nota and nf.Data_Emissao = ni.Data))'
      '      ,Nota'
      '      ,Data'
      '      ,SE = iif(Saida_Entrada = 0, '#39'ENT'#39', '#39'SAI'#39')'
      '      ,Emissao = '#39'PROPRIA'#39' '
      '      ,DI'
      '      ,UM = Unidade_Medida'
      
        '      ,Tipo_Nota = (select Descricao from TipoNota where Codigo ' +
        '= Tipo_Nota)'
      
        '      ,Finalidade_Cod = (select Finalidade_Mercadoria from TipoN' +
        'ota tn where tn.Codigo = ni.Tipo_Nota)'
      
        '      ,Finalidade = case (select Finalidade_Mercadoria from Tipo' +
        'Nota tn where tn.Codigo = ni.Tipo_Nota) '
      '                         when 0 then '#39'REVENDA'#39' '
      '                         when 1 then '#39'CONSUMO'#39' '
      '                         when 2 then '#39'DEVOLU'#199#195'O'#39' '
      '                         when 3 then '#39'EXPORTA'#199#195'O'#39' '
      
        '                         when 4 then '#39'PR'#211'PRIA EM PODER DE TERCEI' +
        'ROS'#39' '
      
        '                         when 5 then '#39'TERCEIROS EM PODER DA EMPR' +
        'ESA'#39' '
      '                         when 6 then '#39'IMOBILIZADO'#39' '
      '                         when 7 then '#39'OUTROS'#39' '
      '                    end'
      '      ,Qtde_Entrada = iif(Saida_Entrada = 0, Quantidade, 0)'
      '      ,Qtde_Saida   = iif(Saida_Entrada = 1, Quantidade, 0)'
      '      ,Saldo_Empresa = 0'
      '      ,Saldo_Armazem = 0'
      
        '      ,Estoque = iif((select Finalidade_Mercadoria from TipoNota' +
        ' tn where tn.Codigo = ni.Tipo_Nota) <> 4, '#39'EMPRESA'#39', '#39'ARMAZEM'#39')'
      'into #temp'
      'from NotasItens ni'
      'where Data between '#39'01/01/2000'#39' and '#39'07/31/2024'#39
      'and Cancelada <> 1'
      'and NFe_Denegada <> 1'
      
        'and (select Finalidade_Mercadoria from TipoNota tn where tn.Codi' +
        'go = ni.Tipo_Nota) in(0, 2, 4)'
      'union all'
      
        'select Armazem = (select Armazem from NotasTerceiros nf where nf' +
        '.Nota = ni.Nota and nf.Data_Emissao = ni.Data_Emissao)'
      
        '      ,Armazem_Nome = (select Nome from Fornecedores fr where fr' +
        '.Codigo = (select Armazem from NotasTerceiros nf where nf.Nota =' +
        ' ni.Nota and nf.Data_Emissao = ni.Data_Emissao))'
      '      ,Nota'
      '      ,Data = Data_Entrada'
      '      ,SE = '#39'ENT'#39' '
      ...
      '      ,UM = Unidade_Medida'
        ...
        '      ,Tipo_Nota = (select Descricao from ReferenciasFiscais whe' +
        're Codigo = Referencia_Fiscal)'
      
        '      ,Finalidade_Cod = (select Finalidade_Mercadoria from Refer' +
        'enciasFiscais where Codigo = Referencia_Fiscal)'
      
        '      ,Finalidade = case (select Finalidade_Mercadoria from Refe' +
        'renciasFiscais where Codigo = Referencia_Fiscal)'
      '                         when 0 then '#39'REVENDA'#39' '
      '                         when 1 then '#39'CONSUMO'#39' '
      '                         when 2 then '#39'DEVOLU'#199#195'O'#39' '
      '                         when 3 then '#39'EXPORTA'#199#195'O'#39' '
      ...
      '    ,Saldo_Armazem = 0'
        ...
        '    ,Estoque = iif((select Finalidade_Mercadoria from Referencia' +
        'sFiscais where Codigo = Referencia_Fiscal) in(0, 2, 4), '#39'EMPRESA' +
        #39', '#39'ARMAZEM'#39')'
      'from NotasTerceirosItens ni'
      'where Data_Entrada between '#39'01/01/2000'#39' and '#39'07/31/2024'#39
      
        'and (select Finalidade_Mercadoria from ReferenciasFiscais where ' +
        'Codigo = Referencia_Fiscal) in(0, 2, 4)'
      
        '--update #temp set Saldo_Empresa = iif(Estoque = '#39'EMPRESA'#39', iif(' +
        'SE = '#39'ENT'#39', Quantidade, Quantidade *-1), 0)'
      
        '--                ,Saldo_Armazem = iif(Estoque = '#39'ARMAZEM'#39', iif(' +
        'SE = '#39'ENT'#39', Quantidade, Quantidade *-1), 0)'
      'select * from #temp order by Armazem, DI, Data, Nota'
      'drop table #temp')
    FetchRows = 1
    Left = 407
    Top = 10
