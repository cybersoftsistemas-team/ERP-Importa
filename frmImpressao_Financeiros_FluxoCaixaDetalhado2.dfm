object Impressao_Financeiros_FluxoCaixaDetalhado2: TImpressao_Financeiros_FluxoCaixaDetalhado2
  Left = 426
  Top = 222
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 170
    Height = 18
    Caption = 'Fluxo de Caixa (Detalhado)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object gBancos: TDBGrid
    ...
    TitleFont.Style = []
    OnDblClick = gBancosDblClick
    OnTitleClick = gBancosTitleClick
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
  ...
  object tFluxo: TMSQuery
    ...
    SQL.Strings = (
      'use Cybersoft_Givotrading_Matriz'
      'select Data = Data_Vencimento'
      '      ,Forma_Tipo'
      '      ,Numero_Doc = Numero_Documento'
      '      ,Beneficiario = case Tipo '
      
        #9'                   when '#39'R'#39' then (select Nome from Clientes cl ' +
        'where cl.Codigo = pr.Cliente)'
      
        #9#9#9'   when '#39'P'#39' then iif(Fornecedor <> '#39#39', (select Nome from Forn' +
        'ecedores fr where fr.Codigo = pr.Fornecedor), (select Nome from ' +
        'Cybersoft_Cadastros.dbo.OrgaosPublicos op where op.Codigo = pr.O' +
        'rgao))'
      #9'    '#9'      end '
      '      ,Debito  = iif(Tipo = '#39'P'#39', Valor_Parcela, 0)'
      '      ,Credito = iif(Tipo = '#39'R'#39', Valor_Parcela, 0)'
      '      ,Saldo = 0'
      '      ,Banco'
      '      ,Processo'
      'from PagarReceber pr'
      'where Data_Vencimento > '#39'08/01/2024'#39
      'and Banco  = 1'
    ...
    object tFluxoForma_Tipo: TStringField
      FieldName = 'Forma_Tipo'
      Size = 25
    end
    object tFluxoNumero_Doc: TStringField
      FieldName = 'Numero_Doc'
      ReadOnly = True
      Size = 15
    end
    object tFluxoBeneficiario: TStringField
      FieldName = 'Beneficiario'
      ReadOnly = True
      Size = 60
    end
    object tFluxoDebito: TCurrencyField
      FieldName = 'Debito'
      ReadOnly = True
      DisplayFormat = ',0.00;-,0.00'
    end
    object tFluxoCredito: TCurrencyField
      FieldName = 'Credito'
      ReadOnly = True
      DisplayFormat = ',0.00;-,0.00'
    end
    object tFluxoProcesso: TStringField
      FieldName = 'Processo'
      Size = 15
    end
  end
  ...
  object rFluxo: TppReport
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo_Fonte\Relatorios\Fluxo Caixa Deta' +
      'lhado.rtm'
    ...
    object ppDetailBand1: TppDetailBand
      AfterGenerate = ppDetailBand1AfterGenerate
      Background1.Brush.Style = bsClear
      Background2.Brush.Color = 16773874
      Border.mmPadding = 0
      PrintHeight = phDynamic
      mmBottomOffset = 0
      mmHeight = 2910
      mmPrintPosition = 0
      object Debito: TppDBText
        DesignLayer = ppDesignLayer1
        UserName = 'Debito'
        BlankWhenZero = True
        Border.Weight = 1.000000000000000000
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object TotalizaBancos: TppSubReport
        DesignLayer = ppDesignLayer1
        UserName = 'TotalizaBancos'
        ExpandAll = False
        NewPrintJob = False
        OutlineSettings.CreateNode = True
        TraverseAllData = False
        DataPipelineName = 'pBancosSaldos'
        mmHeight = 4091
        mmLeft = 0
        mmTop = 6378
        mmWidth = 197380
        ...
        object ppChildReport1: TppChildReport
          ...
          object ppTitleBand1: TppTitleBand
            ...
            object labSaldoAtual: TppLabel
              DesignLayer = ppDesignLayer2
              UserName = 'labSaldoAtual'
              AutoSize = False
              Border.mmPadding = 0
              Caption = 'SALDO'
              Color = 6697728
      ...
      object lTotalSaldo: TppVariable
        DesignLayer = ppDesignLayer1
        UserName = 'Saldo1'
        AutoSize = False
        Border.mmPadding = 0
  ...
  object tBancos: TMSQuery
    ...
    Left = 322
    Top = 100
    object tBancosSel: TBooleanField
      FieldName = 'Sel'
      DisplayValues = 'a'
    end
    ...
    object tBancosAgencia: TStringField
      FieldName = 'Agencia'
      ReadOnly = True
      Size = 15
    end
    ...
    object tBancosData_Saldo: TDateTimeField
      Alignment = taCenter
      DisplayLabel = 'Dt. Saldo'
      DisplayWidth = 12
      FieldName = 'Data_Saldo'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object tBancosSaldo: TCurrencyField
      FieldName = 'Saldo'
      DisplayFormat = ',0.00;-,0.00'
    end
  end
  object dstBancos: TMSDataSource
    DataSet = tBancos
    Left = 322
    Top = 159
  end
  object qrySInit: TMSQuery
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
      
        'SELECT Saldo_Inicial = SUM(IIF(PRB.Tipo = '#39'P'#39', PRB.Valor * -1, P' +
        'RB.Valor))'
      'FROM PagarReceberBaixas AS PRB'
      'WHERE PRB.Data < :pData'
      'AND ISNULL(PRB.Banco, 0) <> 0')
    Left = 118
    Top = 100
    ParamData = <
      item
  ...
  object dsSInit: TDataSource
    DataSet = qrySInit
    Left = 115
    Top = 154
  end
  object tBancosSaldos: TMSQuery
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
      'select ban.Conta'
      '      ,ban.Nome'
      
        '      ,Saldo = ban.Saldo + (select sum(iif(prb.Tipo = '#39'P'#39', prb.V' +
        'alor * -1, prb.Valor)) from PagarReceberBaixas prb where prb.Ban' +
  ...
  object dstBancosSaldos: TDataSource
    DataSet = tBancosSaldos
    Left = 228
    Top = 153
  end
  object pBancosSaldos: TppDBPipeline
    DataSource = dstBancosSaldos
    CloseDataSource = True
    UserName = 'pBancosSaldos'
    Left = 417
    Top = 12
    ...
    object pBancosSaldosppField3: TppField
      FieldAlias = 'Saldo'
      FieldName = 'Saldo'
      FieldLength = 0
      DataType = dtCurrency
  ...
  object rFluxoSint: TppReport
    ...
    object ppDetailBand3: TppDetailBand
      ...
      object SaldoSint: TppVariable
        ...
        BandType = 4
        LayerName = Foreground2
        CalcDataPipelineName = 'ppDetailBand3'
      end
    ...
    object ppSummaryBand3: TppSummaryBand
      ...
      object TotalizaBancosSint: TppSubReport
        DesignLayer = ppDesignLayer4
        UserName = 'psbrBancos'
        ExpandAll = False
        NewPrintJob = False
        ...
        object ppChildReport2: TppChildReport
          ...
          object ppTitleBand2: TppTitleBand
            ...
            object lSaldoBancosSint: TppLabel
              DesignLayer = ppDesignLayer3
              UserName = 'labBanco2'
              AutoSize = False
              Border.mmPadding = 0
      ...
      object lTotalSaldoSint: TppVariable
        DesignLayer = ppDesignLayer4
        UserName = 'Saldo1'
        AutoSize = False
        Border.mmPadding = 0
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        object InicialSalSint: TppVariable
          DesignLayer = ppDesignLayer4
          UserName = 'InicialSal'
          AutoSize = False
          Border.mmPadding = 0
  ...
  object tCCusto: TMSQuery
    ...
    object tCCustoCodigo: TStringField
      FieldName = 'Codigo'
      Size = 10
    end
    object tCCustoDescricao: TStringField
      FieldName = 'Descricao'
      Size = 30
    end
  end
  object dstCCusto: TMSDataSource
    DataSet = tCCusto
    Left = 323
    Top = 273
  end
