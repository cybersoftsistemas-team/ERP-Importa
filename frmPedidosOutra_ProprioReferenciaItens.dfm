object PedidosOutra_ProprioReferenciaItens: TPedidosOutra_ProprioReferenciaItens
  Left = 471
  Top = 121
  BorderStyle = bsDialog
  Caption = 'PedidosOutra_ProprioReferenciaItens'
  ClientHeight = 575
  ClientWidth = 903
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 356
    Height = 18
    Caption = 'Importa'#231#227'o de itens de nota fiscal de refer'#234'ncia (Pr'#243'pria).'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
