object Impressao_ProcessosOP_Relacao: TImpressao_ProcessosOP_Relacao
  Left = 501
  Top = 223
  BorderStyle = bsDialog
  Caption = 'Impressao_ProcessosOP_Relacao'
  ClientHeight = 595
  ClientWidth = 482
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 136
    Height = 18
    Caption = 'Rela'#231#227'o de processos.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object cDataProcessoIni: TDateEdit
    Left = 105
    Top = 52
    Width = 106
    Height = 21
  ...
  object cDataProcessoFim: TDateEdit
    Left = 253
    Top = 52
    Width = 106
    Height = 21
  ...
  object cDataRegistroIni: TDateEdit
    Left = 105
    Top = 98
    Width = 106
    Height = 21
  ...
  object cDataRegistroFim: TDateEdit
    Left = 253
    Top = 98
    Width = 106
    Height = 21
  ...
  object cUFDesemb: TRxDBLookupCombo
    Left = 105
    Top = 281
    Width = 369
    Height = 21
  ...
  object cProcesso: TRxDBLookupCombo
    ...
    LookupDisplayIndex = 1
    LookupSource = dstProc
    ParentFont = False
    TabOrder = 38
  end
  object rRelacaoProcesso: TppReport
    AutoStop = False
    DataPipeline = pProcessos
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Rela'#231#227'o de Processos'
    ...
    Template.FileName = 
      'C:\Sistemas\Faturamento\Codigo Fonte\Relatorios\Rela'#231#227'o Processo' +
      's.rtm'
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupFooterBand1: TppGroupFooterBand
        ...
        mmHeight = 6879
        mmPrintPosition = 0
        object lTotalCliente_ME: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'lTotalCliente_ME'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 0
        ...
        object lTotalCliente_Real: TppVariable
          DesignLayer = ppDesignLayer1
          UserName = 'lTotalCliente_Real'
          AutoSize = False
          Border.mmPadding = 0
          BlankWhenZero = False
          CalcOrder = 1
  ...
  object tOrigens: TMSQuery
    Connection = Dados.Banco_Empresas
    Left = 278
    Top = 60
  end
  object tVia: TMSQuery
    Connection = Dados.Banco_Empresas
    Left = 280
    Top = 8
  end
  object tProc: TMSQuery
    Connection = Dados.Banco_Empresas
    SQL.Strings = (
      'SELECT Processo_Mestre'
      '      ,Processo'
  ...
  object tProcessos: TMSQuery
    ...
    SQL.Strings = (
      ...
      '       Courrier,'
        ...
        '= ProcessosDocumentos.Fornecedor)),'
      '       Data_RegistroDeclaracao,'
      '       Data_DesembaracoDeclaracao,'
      '       Origem,'
      '       FOB, '
      '       CIF_ME = (FOB_ME + Frete_ME + Seguro_ME),'
      '       Taxa_FOB,'
      '       CIF_Real = FOB + Frete + Seguro,'
      
        '       Via_Transporte = (SELECT Descricao FROM Cybersoft_Cadastr' +
        'os.dbo.ViaTransporte WHERE Codigo = Via_Transporte),'
      '       Canal = CASE '
      #9'           WHEN Canal_SISCOMEX = '#39'VD'#39' THEN '#39'VERDE'#39
      #9'           WHEN Canal_SISCOMEX = '#39'AM'#39' THEN '#39'AMARELO'#39
      #9'           WHEN Canal_SISCOMEX = '#39'VM'#39' THEN '#39'VERMELHO'#39
      #9'           WHEN Canal_SISCOMEX = '#39'CZ'#39' THEN '#39'CINZA'#39
      #9'       END'
      'FROM   ProcessosDocumentos')
    Left = 216
    Top = 7
  end
  object dstProc: TDataSource
    DataSet = tProc
    Left = 220
    Top = 174
  end
