object NotaFiscal_TerceirosVinculo: TNotaFiscal_TerceirosVinculo
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'NotaFiscal_TerceirosVinculo'
  ClientHeight = 501
  ClientWidth = 1009
  Color = clBtnFace
  ...
  object cOcultar: TCheckBox
    Left = 19
    Top = 442
    Width = 104
    Height = 17
    Caption = 'Ocultar baixados'
    TabOrder = 4
    OnClick = cOcultarClick
  end
