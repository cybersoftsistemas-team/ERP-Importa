object Impressao_ControleNaviosBL: TImpressao_ControleNaviosBL
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Impressao_ControleNaviosBL'
  ClientHeight = 289
  ClientWidth = 538
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 102
    Height = 18
    Caption = 'Hist'#243'rico de BL'#39's'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object tBL: TMSQuery
    ...
    SQL.Strings = (
      ...
      '      ,Data_Bl            = format(Data_Emissao, '#39'd'#39', '#39'pt-br'#39')'
      
        '      ,Data_Carregamento  = format((select Data_Operacao from Co' +
        'ntroleNaviosLaudo cnl where cnl.Navio = cnb.Navio and cnl.Laudo ' +
        '= cnb.Laudo), '#39'd'#39', '#39'pr-br'#39')'
      '      ,Ton_Vac           '
      '      ,Ton_Air'
      '      ,Qtde_M315          = Quantidade_M315'
      '      ,Qtde_M320          = Quantidade_M320'
      '      ,Quantidade_LT15'
      '      ,Quantidade_LT20'
      '      ,Obs                = Observacao'
