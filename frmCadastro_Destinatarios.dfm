object Cadastro_Destinatarios: TCadastro_Destinatarios
  Left = 550
  Top = 228
  BorderStyle = bsDialog
  Caption = 'Cadastro_Destinatarios'
  ClientHeight = 323
  ClientWidth = 639
  Color = clBtnFace
  ...
  object RxLabel4: TRxLabel
    ...
    Width = 251
    Height = 18
    Caption = 'Manuten'#231#227'o da tabela de Destinat'#225'rios.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object Panel1: TPanel
    ...
    object Navega: TDBNavigator
      ...
      Height = 28
      Cursor = crHandPoint
      DataSource = Dados.dsDestinatarios
  ...
  object tCodigo: TMSQuery
    ...
    SQL.Strings = (
      'SELECT MAX(Codigo) AS Codigo FROM Destinatarios')
    Left = 272
    Top = 8
  end
