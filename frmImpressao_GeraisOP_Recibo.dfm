object ImpressaoGeraisOP_Recibo: TImpressaoGeraisOP_Recibo
  Left = 441
  Top = 182
  BorderStyle = bsDialog
  Caption = 'ImpressaoGeraisOP_Recibo'
  ClientHeight = 335
  ClientWidth = 617
  Color = clBtnFace
  ...
  object RxLabel2: TRxLabel
    ...
    Width = 227
    Height = 18
    Caption = 'Recibo de Pagamento/Recebimento.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -15
    Font.Name = 'Calibri'
  ...
  object rG01: TppReport
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Cybersoft - Declaracao de Recebimento de Nota Fiscal'
    ...
    Template.FileName = 'C:\Sistemas\Faturamento\Codigo_Fonte\Relatorios\Recibo01.rtm'
    ArchiveFileName = '($MyDocuments)\ReportArchive.raf'
    BeforePrint = rG01BeforePrint
    DeviceType = 'Screen'
    ...
    object ppDetailBand1: TppDetailBand
      ...
      mmHeight = 200025
      mmPrintPosition = 0
      object lTexto1: TppMemo
        DesignLayer = ppDesignLayer1
        UserName = 'lTexto1'
        ForceJustifyLastLine = True
        Border.mmPadding = 0
        Caption = 
          'Recebi de <{Empresa>} as mercadorias constantes da nota fiscal m' +
          'odelo "<{Modelo>}" n'#250'mero <{Numero>} de <{Data>}'
        CharWrap = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Calibri'
        ...
        Lines.Strings = (
            ...
            'Recebemos de <{Pessoa}> a import'#226'cia de R$ <{Valor}> <{Extenso}>' +
      ...
      object lAssinatura: TppLabel
        DesignLayer = ppDesignLayer1
        UserName = 'lAssinatura'
        AutoSize = False
        Border.mmPadding = 0
        Caption = 'lAssinatura'
        Font.Charset = DEFAULT_CHARSET
      ...
      object lAssinaturaCPFCNPJ: TppLabel
        DesignLayer = ppDesignLayer1
        UserName = 'lAssinaturaCPFCNPJ'
        Border.mmPadding = 0
        Caption = 'lAssinaturaCPFCNPJ'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Tahoma'
        Font.Size = 10
